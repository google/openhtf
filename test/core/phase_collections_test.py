...
class PhaseSequenceTest(unittest.TestCase):
  ...
  def test_load_code_info(self):
    ...
    self.assertEqual(
        test_record.CodeInfo.for_function(empty_phase.func), phases[0].code_info
    )
    self.assertEqual(
  ...
  def test_apply_to_all_phases(self):
    ...
    self.assertEqual(
        mock_node.apply_to_all_phases.return_value, updated.nodes[2]
    )
...
class PhaseSequenceIntegrationTest(htf_test.TestCase):
  ...
  def test_nested(self):
    ...
    self.assertPhasesOutcomeByName(
        test_record.PhaseOutcome.PASS, test_rec, 'phase', 'empty_phase'
    )
...
class SubtestIntegrationTest(htf_test.TestCase):
  ...
  def test_pass(self):
    ...
    self.assertPhasesOutcomeByName(
        test_record.PhaseOutcome.PASS, test_rec, 'phase'
    )
  ...
  def test_fail_but_still_continues(self):
    subtest = phase_collections.Subtest(
        'failure', fail_subtest_phase, skip_phase
    )
  ...
  def test_error(self):
    ...
    self.assertPhasesOutcomeByName(
        test_record.PhaseOutcome.ERROR, test_rec, 'error_phase'
    )
  ...
  def test_pass__with_group(self):
    ...
    self.assertPhasesOutcomeByName(
        test_record.PhaseOutcome.PASS, test_rec, 'phase', 'teardown_phase'
    )
  ...
  def test_fail__with_group(self):
    subtest = phase_collections.Subtest(
        'it_fails', teardown_group.wrap(fail_subtest_phase), skip_phase
    )
  ...
  def test_fail__with_nested_group_skipped(self):
    subtest = phase_collections.Subtest(
        'it_fails',
        fail_subtest_phase,
        htf.PhaseGroup(main=[skip_phase0], teardown=[skip_phase1]),
        skip_phase,
    )
  ...
  def test_error__with_group(self):
    subtest = phase_collections.Subtest(
        'it_errors', teardown_group.wrap(error_phase)
    )
  ...
  def test_fail_subtest__nested_subtest_also_skipped(self):
    subtest = phase_collections.Subtest(
        ...
        fail_subtest_phase,
        skip_phase0,
        phase_collections.Subtest('inner', skip_phase),
        skip_phase1,
    )
    ...
    self.assertPhasesOutcomeByName(
        test_record.PhaseOutcome.FAIL, test_rec, 'fail_subtest_phase'
    )
    self.assertPhasesOutcomeByName(
  ...
  def test_fail_subtest__skip_checkpoint(self):
    subtest = phase_collections.Subtest(
        'skip_checkpoint',
        fail_subtest_phase,
        htf.PhaseFailureCheckpoint('must_be_skipped'),
        skip_phase,
    )
  ...
  def test_fail_subtest__skip_branch_that_would_not_run(self):
    ...
    subtest = phase_collections.Subtest(
        'skip_branch',
        fail_subtest_phase,
        htf.BranchSequence(_Diag.NOT_SET, error_phase),
        skip_phase,
    )
    ...
    self.assertPhasesOutcomeByName(
        test_record.PhaseOutcome.SKIP, test_rec, 'skip_phase'
    )
    self.assertPhasesOutcomeByName(
        test_record.PhaseOutcome.PASS, test_rec, 'phase'
    )
  ...
  def test_fail_subtest__skip_branch_that_would_run(self):
    ...
    subtest = phase_collections.Subtest(
        ...
        fail_subtest_phase,
        htf.BranchSequence(
            htf.DiagnosisCondition.on_all(_Diag.SET), error_phase
        ),
        skip_phase,
    )
    ...
    self.assertPhasesOutcomeByName(
        test_record.PhaseOutcome.PASS, test_rec, 'diag_phase', 'phase'
    )
    self.assertPhasesNotRun(test_rec, 'error_phase')
