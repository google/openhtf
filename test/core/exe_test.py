...
class TestExecutorExecuteBranchTest(parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ...
      # on_not_any
      (
          'on_not_any__one__not_triggered',
          'on_not_any',
          BranchDiag.ONE,
          _NO_RESULTS,
          True,
      ...
      # not_all
      (
          'on_not_all__one__not_triggered',
          'on_not_all',
          _ONE_RESULT,
          _NO_RESULTS,
          True,
  ...
  def test_branch(self, constructor_name, constructor_diags, results, called):
    diag_cond = getattr(phase_branches.DiagnosisCondition, constructor_name)(
        *constructor_diags
    )
