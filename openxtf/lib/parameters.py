  ...
  class ParameterInstance(object):
    ...
    def __init__(self, test_run, descriptor):
      if not descriptor.optional:
        ...
        self._parameter = xtf_pb2.TestParameter()
      ...
      self._parameter.status = xtf_pb2.ERROR
...
class TextParameterDescriptor(data.BaseDataDescriptor):
  name = 'Text'
  info_tag = xtf_pb2.InformationParameter.TEXT_UTF8
...
class JpgParameterDescriptor(data.BaseDataDescriptor):
  name = 'JPG'
  info_tag = xtf_pb2.InformationParameter.JPG
  Transform = staticmethod(str)  # pylint: disable=invalid-name
...
class PngParameterDescriptor(data.BaseDataDescriptor):
  name = 'PNG'
  info_tag = xtf_pb2.InformationParameter.PNG
  Transform = staticmethod(str)  # pylint: disable=invalid-name
...
class WavParameterDescriptor(data.BaseDataDescriptor):
  name = 'WAV'
  info_tag = xtf_pb2.InformationParameter.WAV
  Transform = staticmethod(str)  # pylint: disable=invalid-name
...
class BinaryParameterDescriptor(data.BaseDataDescriptor):
  name = 'Binary'
  info_tag = xtf_pb2.InformationParameter.BINARY
  Transform = staticmethod(str)  # pylint: disable=invalid-name
...
class TimeseriesParameterDescriptor(data.BaseDataDescriptor):
  name = 'Timeseries'
  info_tag = xtf_pb2.InformationParameter.TIMESERIES
  Transform = staticmethod(str)  # pylint: disable=invalid-name
...
def GetUomFromUnitCode(unit_code):
  ...
  """
  uom_code = (xtf_pb2.Units.UnitCode.DESCRIPTOR.values_by_number[
      unit_code].GetOptions().Extensions[xtf_pb2.uom_code])
  if uom_code:
    return uom_code
  return None
