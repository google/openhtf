...
KILOGRAM_PER_LITRE_KG_PER_L = UnitDescriptor('kilogram per litre', 'B35', '''kg/L''')
ALL_UNITS.append(KILOGRAM_PER_LITRE_KG_PER_L)
...
DECITONNE_DTN = UnitDescriptor('decitonne', 'DTN', '''dtn''')
ALL_UNITS.append(DECITONNE_DTN)
...
RACK_UNIT_RU = UnitDescriptor('rack unit', 'H80', '''RU''')
ALL_UNITS.append(RACK_UNIT_RU)
