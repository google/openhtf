...
HUNDRED_FIFTEEN_KG_DRUM = UnitDescriptor(
...
FIFTYFIVE_GALLON_US_DRUM = UnitDescriptor(
...
GRAM_PER_CUBIC_CENTIMETRE = UnitDescriptor(
    'gram per cubic centimetre', '23', """g/cm³"""
)
...
GRAM_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'gram per square centimetre', '25', """g/cm²"""
)
...
KILOGRAM_PER_SQUARE_METRE = UnitDescriptor(
    'kilogram per square metre', '28', """kg/m²"""
)
ALL_UNITS.append(KILOGRAM_PER_SQUARE_METRE)
POUND_PER_THOUSAND_SQUARE_FOOT = UnitDescriptor(
    'pound per thousand square foot', '29', """lb/kft²"""
)
...
KILOGRAM_PER_AIR_DRY_METRIC_TON = UnitDescriptor(
    'kilogram per air dry metric ton', '32', """"""
)
ALL_UNITS.append(KILOGRAM_PER_AIR_DRY_METRIC_TON)
KILOPASCAL_SQUARE_METRE_PER_GRAM = UnitDescriptor(
    'kilopascal square metre per gram', '33', """kPa·m²/g"""
)
ALL_UNITS.append(KILOPASCAL_SQUARE_METRE_PER_GRAM)
KILOPASCAL_PER_MILLIMETRE = UnitDescriptor(
    'kilopascal per millimetre', '34', """kPa/mm"""
)
ALL_UNITS.append(KILOPASCAL_PER_MILLIMETRE)
MILLILITRE_PER_SQUARE_CENTIMETRE_SECOND = UnitDescriptor(
    'millilitre per square centimetre second', '35', """ml/(cm²·s)"""
)
ALL_UNITS.append(MILLILITRE_PER_SQUARE_CENTIMETRE_SECOND)
CUBIC_FOOT_PER_MINUTE_PER_SQUARE_FOOT = UnitDescriptor(
    'cubic foot per minute per square foot', '36', """ft³/(min/ft²)"""
)
ALL_UNITS.append(CUBIC_FOOT_PER_MINUTE_PER_SQUARE_FOOT)
OUNCE_PER_SQUARE_FOOT = UnitDescriptor(
    'ounce per square foot', '37', """oz/ft²"""
)
ALL_UNITS.append(OUNCE_PER_SQUARE_FOOT)
OUNCE_PER_SQUARE_FOOT_PER_0_01INCH = UnitDescriptor(
    'ounce per square foot per 0,01inch', '38', """oz/(ft²/cin)"""
)
ALL_UNITS.append(OUNCE_PER_SQUARE_FOOT_PER_0_01INCH)
MILLILITRE_PER_SECOND = UnitDescriptor(
    'millilitre per second', '40', """ml/s"""
)
ALL_UNITS.append(MILLILITRE_PER_SECOND)
MILLILITRE_PER_MINUTE = UnitDescriptor(
    'millilitre per minute', '41', """ml/min"""
)
ALL_UNITS.append(MILLILITRE_PER_MINUTE)
SUPER_BULK_BAG = UnitDescriptor('super bulk bag', '43', """""")
ALL_UNITS.append(SUPER_BULK_BAG)
FIVEHUNDRED_KG_BULK_BAG = UnitDescriptor(
    'fivehundred kg bulk bag', '44', """"""
)
ALL_UNITS.append(FIVEHUNDRED_KG_BULK_BAG)
THREEHUNDRED_KG_BULK_BAG = UnitDescriptor(
...
POUND_PER_SQUARE_INCH_GAUGE = UnitDescriptor(
    'pound per square inch, gauge', '64', """"""
)
...
AMPERE_TUM_PER_CENTIMETRE = UnitDescriptor(
...
POUND_PER_SQUARE_INCH_ABSOLUTE = UnitDescriptor(
    'pound per square inch absolute', '80', """lb/in²"""
)
ALL_UNITS.append(POUND_PER_SQUARE_INCH_ABSOLUTE)
HENRY = UnitDescriptor('henry', '81', """H""")
ALL_UNITS.append(HENRY)
KILOPOUND_FORCE_PER_SQUARE_INCH = UnitDescriptor(
    'kilopound-force per square inch', '84', """klbf/in²"""
)
...
POUND_PER_CUBIC_FOOT = UnitDescriptor(
    'pound per cubic foot', '87', """lb/ft³"""
)
ALL_UNITS.append(POUND_PER_CUBIC_FOOT)
POISE = UnitDescriptor('poise', '89', """P""")
ALL_UNITS.append(POISE)
SAYBOLD_UNIVERSAL_SECOND = UnitDescriptor(
...
CALORIE_PER_CUBIC_CENTIMETRE = UnitDescriptor(
    'calorie per cubic centimetre', '92', """"""
)
...
TWENTY_THOUSAND_GALLON_US_TANKCAR = UnitDescriptor(
    'twenty thousand gallon (US) tankcar', '95', """"""
)
ALL_UNITS.append(TWENTY_THOUSAND_GALLON_US_TANKCAR)
TEN_THOUSAND_GALLON_US_TANKCAR = UnitDescriptor(
...
RADIAN_PER_SECOND_SQUARED = UnitDescriptor(
    'radian per second squared', '2B', """rad/s²"""
)
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_HOUR = UnitDescriptor(
    'British thermal unit (international table) per hour', '2I', """BtuIT/h"""
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_HOUR)
CUBIC_CENTIMETRE_PER_SECOND = UnitDescriptor(
    'cubic centimetre per second', '2J', """cm³/s"""
)
...
CUBIC_FOOT_PER_MINUTE = UnitDescriptor(
    'cubic foot per minute', '2L', """ft³/min"""
)
ALL_UNITS.append(CUBIC_FOOT_PER_MINUTE)
CENTIMETRE_PER_SECOND = UnitDescriptor(
    'centimetre per second', '2M', """cm/s"""
)
...
BARREL_US_PER_MINUTE = UnitDescriptor(
    'barrel (US) per minute', '5A', """barrel (US)/min"""
)
...
AMPERE_SQUARE_METRE_PER_JOULE_SECOND = UnitDescriptor(
    'ampere square metre per joule second', 'A10', """A·m²/(J·s)"""
)
...
BARN_PER_ELECTRONVOLT = UnitDescriptor(
    'barn per electronvolt', 'A15', """b/eV"""
)
ALL_UNITS.append(BARN_PER_ELECTRONVOLT)
BARN_PER_STERADIAN_ELECTRONVOLT = UnitDescriptor(
    'barn per steradian electronvolt', 'A16', """b/(sr·eV)"""
)
...
BECQUEREL_PER_KILOGRAM = UnitDescriptor(
    'becquerel per kilogram', 'A18', """Bq/kg"""
)
ALL_UNITS.append(BECQUEREL_PER_KILOGRAM)
BECQUEREL_PER_CUBIC_METRE = UnitDescriptor(
    'becquerel per cubic metre', 'A19', """Bq/m³"""
)
ALL_UNITS.append(BECQUEREL_PER_CUBIC_METRE)
AMPERE_PER_CENTIMETRE = UnitDescriptor(
    'ampere per centimetre', 'A2', """A/cm"""
)
ALL_UNITS.append(AMPERE_PER_CENTIMETRE)
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_SECOND_SQUARE_FOOT_DEGREE_RANKINE = UnitDescriptor(
    (
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_HOUR_SQUARE_FOOT_DEGREE_RANKINE = UnitDescriptor(
    (
...
CANDELA_PER_SQUARE_METRE = UnitDescriptor(
    'candela per square metre', 'A24', """cd/m²"""
)
...
COULOMB_METRE_SQUARED_PER_VOLT = UnitDescriptor(
    'coulomb metre squared per volt', 'A27', """C·m²/V"""
)
ALL_UNITS.append(COULOMB_METRE_SQUARED_PER_VOLT)
COULOMB_PER_CUBIC_CENTIMETRE = UnitDescriptor(
    'coulomb per cubic centimetre', 'A28', """C/cm³"""
)
ALL_UNITS.append(COULOMB_PER_CUBIC_CENTIMETRE)
COULOMB_PER_CUBIC_METRE = UnitDescriptor(
    'coulomb per cubic metre', 'A29', """C/m³"""
)
ALL_UNITS.append(COULOMB_PER_CUBIC_METRE)
AMPERE_PER_MILLIMETRE = UnitDescriptor(
    'ampere per millimetre', 'A3', """A/mm"""
)
ALL_UNITS.append(AMPERE_PER_MILLIMETRE)
COULOMB_PER_CUBIC_MILLIMETRE = UnitDescriptor(
    'coulomb per cubic millimetre', 'A30', """C/mm³"""
)
ALL_UNITS.append(COULOMB_PER_CUBIC_MILLIMETRE)
COULOMB_PER_KILOGRAM_SECOND = UnitDescriptor(
    'coulomb per kilogram second', 'A31', """C/(kg·s)"""
)
...
COULOMB_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'coulomb per square centimetre', 'A33', """C/cm²"""
)
ALL_UNITS.append(COULOMB_PER_SQUARE_CENTIMETRE)
COULOMB_PER_SQUARE_METRE = UnitDescriptor(
    'coulomb per square metre', 'A34', """C/m²"""
)
ALL_UNITS.append(COULOMB_PER_SQUARE_METRE)
COULOMB_PER_SQUARE_MILLIMETRE = UnitDescriptor(
    'coulomb per square millimetre', 'A35', """C/mm²"""
)
ALL_UNITS.append(COULOMB_PER_SQUARE_MILLIMETRE)
CUBIC_CENTIMETRE_PER_MOLE = UnitDescriptor(
    'cubic centimetre per mole', 'A36', """cm³/mol"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_MOLE)
CUBIC_DECIMETRE_PER_MOLE = UnitDescriptor(
    'cubic decimetre per mole', 'A37', """dm³/mol"""
)
ALL_UNITS.append(CUBIC_DECIMETRE_PER_MOLE)
CUBIC_METRE_PER_COULOMB = UnitDescriptor(
    'cubic metre per coulomb', 'A38', """m³/C"""
)
ALL_UNITS.append(CUBIC_METRE_PER_COULOMB)
CUBIC_METRE_PER_KILOGRAM = UnitDescriptor(
    'cubic metre per kilogram', 'A39', """m³/kg"""
)
ALL_UNITS.append(CUBIC_METRE_PER_KILOGRAM)
AMPERE_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'ampere per square centimetre', 'A4', """A/cm²"""
)
ALL_UNITS.append(AMPERE_PER_SQUARE_CENTIMETRE)
CUBIC_METRE_PER_MOLE = UnitDescriptor(
    'cubic metre per mole', 'A40', """m³/mol"""
)
ALL_UNITS.append(CUBIC_METRE_PER_MOLE)
AMPERE_PER_SQUARE_METRE = UnitDescriptor(
    'ampere per square metre', 'A41', """A/m²"""
)
...
DYNE_SECOND_PER_CUBIC_CENTIMETRE = UnitDescriptor(
    'dyne second per cubic centimetre', 'A50', """dyn·s/cm³"""
)
ALL_UNITS.append(DYNE_SECOND_PER_CUBIC_CENTIMETRE)
DYNE_SECOND_PER_CENTIMETRE = UnitDescriptor(
    'dyne second per centimetre', 'A51', """dyn·s/cm"""
)
ALL_UNITS.append(DYNE_SECOND_PER_CENTIMETRE)
DYNE_SECOND_PER_CENTIMETRE_TO_THE_FIFTH_POWER = UnitDescriptor(
    'dyne second per centimetre to the fifth power', 'A52', """dyn·s/cm⁵"""
)
...
ELECTRONVOLT_PER_METRE = UnitDescriptor(
    'electronvolt per metre', 'A54', """eV/m"""
)
ALL_UNITS.append(ELECTRONVOLT_PER_METRE)
ELECTRONVOLT_SQUARE_METRE = UnitDescriptor(
    'electronvolt square metre', 'A55', """eV·m²"""
)
ALL_UNITS.append(ELECTRONVOLT_SQUARE_METRE)
ELECTRONVOLT_SQUARE_METRE_PER_KILOGRAM = UnitDescriptor(
    'electronvolt square metre per kilogram', 'A56', """eV·m²/kg"""
)
...
AMPERE_PER_SQUARE_METRE_KELVIN_SQUARED = UnitDescriptor(
    'ampere per square metre kelvin squared', 'A6', """A/(m²·K²)"""
)
ALL_UNITS.append(AMPERE_PER_SQUARE_METRE_KELVIN_SQUARED)
ERG_PER_CUBIC_CENTIMETRE = UnitDescriptor(
    'erg per cubic centimetre', 'A60', """erg/cm³"""
)
ALL_UNITS.append(ERG_PER_CUBIC_CENTIMETRE)
ERG_PER_GRAM = UnitDescriptor('erg per gram', 'A61', """erg/g""")
ALL_UNITS.append(ERG_PER_GRAM)
ERG_PER_GRAM_SECOND = UnitDescriptor(
    'erg per gram second', 'A62', """erg/g·s"""
)
...
ERG_PER_SECOND_SQUARE_CENTIMETRE = UnitDescriptor(
    'erg per second square centimetre', 'A64', """erg/(s·cm²)"""
)
ALL_UNITS.append(ERG_PER_SECOND_SQUARE_CENTIMETRE)
ERG_PER_SQUARE_CENTIMETRE_SECOND = UnitDescriptor(
    'erg per square centimetre second', 'A65', """erg/(cm²·s)"""
)
ALL_UNITS.append(ERG_PER_SQUARE_CENTIMETRE_SECOND)
ERG_SQUARE_CENTIMETRE = UnitDescriptor(
    'erg square centimetre', 'A66', """erg·cm²"""
)
ALL_UNITS.append(ERG_SQUARE_CENTIMETRE)
ERG_SQUARE_CENTIMETRE_PER_GRAM = UnitDescriptor(
    'erg square centimetre per gram', 'A67', """erg·cm²/g"""
)
...
AMPERE_PER_SQUARE_MILLIMETRE = UnitDescriptor(
    'ampere per square millimetre', 'A7', """A/mm²"""
)
...
FOOT_PER_SECOND_SQUARED = UnitDescriptor(
    'foot per second squared', 'A73', """ft/s²"""
)
ALL_UNITS.append(FOOT_PER_SECOND_SQUARED)
FOOT_POUND_FORCE_PER_SECOND = UnitDescriptor(
    'foot pound-force per second', 'A74', """ft·lbf/s"""
)
...
GAUSSIAN_CGS_CENTIMETRE_GRAM_SECOND_SYSTEM_UNIT_OF_ELECTRIC_FIELD_STRENGTH = UnitDescriptor(
    (
        'Gaussian CGS (Centimetre-Gram-Second system) unit of electric field'
        ' strength'
    ),
    'A80',
    """""",
...
GAUSSIAN_CGS_CENTIMETRE_GRAM_SECOND_SYSTEM_UNIT_OF_ELECTRIC_POLARIZATION = UnitDescriptor(
    (
        'Gaussian CGS (Centimetre-Gram-Second system) unit of electric'
        ' polarization'
    ),
    'A81',
    """""",
...
GIGACOULOMB_PER_CUBIC_METRE = UnitDescriptor(
    'gigacoulomb per cubic metre', 'A84', """GC/m³"""
)
...
AVERAGE_MINUTE_PER_CALL = UnitDescriptor(
...
TROY_OUNCE_OR_APOTHECARY_OUNCE = UnitDescriptor(
    'troy ounce or apothecary ounce', 'APZ', """tr oz"""
)
ALL_UNITS.append(TROY_OUNCE_OR_APOTHECARY_OUNCE)
ANTI_HEMOPHILIC_FACTOR_AHF_UNIT = UnitDescriptor(
...
ALCOHOLIC_STRENGTH_BY_MASS = UnitDescriptor(
    'alcoholic strength by mass', 'ASM', """"""
)
ALL_UNITS.append(ALCOHOLIC_STRENGTH_BY_MASS)
ALCOHOLIC_STRENGTH_BY_VOLUME = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_POUND = UnitDescriptor(
    'British thermal unit (international table) per pound', 'AZ', """BtuIT/lb"""
)
...
BARREL_US_PER_DAY = UnitDescriptor(
    'barrel (US) per day', 'B1', """barrel (US)/d"""
)
ALL_UNITS.append(BARREL_US_PER_DAY)
BIT_PER_SECOND = UnitDescriptor('bit per second', 'B10', """bit/s""")
ALL_UNITS.append(BIT_PER_SECOND)
JOULE_PER_KILOGRAM_KELVIN = UnitDescriptor(
    'joule per kilogram kelvin', 'B11', """J/(kg·K)"""
)
...
JOULE_PER_SQUARE_METRE = UnitDescriptor(
    'joule per square metre', 'B13', """J/m²"""
)
ALL_UNITS.append(JOULE_PER_SQUARE_METRE)
JOULE_PER_METRE_TO_THE_FOURTH_POWER = UnitDescriptor(
    'joule per metre to the fourth power', 'B14', """J/m⁴"""
)
...
JOULE_PER_MOLE_KELVIN = UnitDescriptor(
    'joule per mole kelvin', 'B16', """J/(mol·K)"""
)
...
JOULE_SQUARE_METRE_PER_KILOGRAM = UnitDescriptor(
    'joule square metre per kilogram', 'B20', """J·m²/kg"""
)
...
KILOAMPERE_PER_SQUARE_METRE = UnitDescriptor(
    'kiloampere per square metre', 'B23', """kA/m²"""
)
...
KILOBECQUEREL_PER_KILOGRAM = UnitDescriptor(
    'kilobecquerel per kilogram', 'B25', """kBq/kg"""
)
ALL_UNITS.append(KILOBECQUEREL_PER_KILOGRAM)
KILOCOULOMB = UnitDescriptor('kilocoulomb', 'B26', """kC""")
ALL_UNITS.append(KILOCOULOMB)
KILOCOULOMB_PER_CUBIC_METRE = UnitDescriptor(
    'kilocoulomb per cubic metre', 'B27', """kC/m³"""
)
ALL_UNITS.append(KILOCOULOMB_PER_CUBIC_METRE)
KILOCOULOMB_PER_SQUARE_METRE = UnitDescriptor(
    'kilocoulomb per square metre', 'B28', """kC/m²"""
)
...
KILOGRAM_METRE_PER_SECOND = UnitDescriptor(
    'kilogram metre per second', 'B31', """kg·m/s"""
)
ALL_UNITS.append(KILOGRAM_METRE_PER_SECOND)
KILOGRAM_METRE_SQUARED = UnitDescriptor(
    'kilogram metre squared', 'B32', """kg·m²"""
)
ALL_UNITS.append(KILOGRAM_METRE_SQUARED)
KILOGRAM_METRE_SQUARED_PER_SECOND = UnitDescriptor(
    'kilogram metre squared per second', 'B33', """kg·m²/s"""
)
ALL_UNITS.append(KILOGRAM_METRE_SQUARED_PER_SECOND)
KILOGRAM_PER_CUBIC_DECIMETRE = UnitDescriptor(
    'kilogram per cubic decimetre', 'B34', """kg/dm³"""
)
...
KILOGRAM_PER_LITRE = UnitDescriptor('kilogram per litre', 'B35', """kg/L""")
ALL_UNITS.append(KILOGRAM_PER_LITRE)
CALORIE_THERMOCHEMICAL_PER_GRAM = UnitDescriptor(
    'calorie (thermochemical) per gram', 'B36', """calth/g"""
)
...
KILOGRAM_FORCE_METRE = UnitDescriptor(
    'kilogram-force metre', 'B38', """kgf·m"""
)
ALL_UNITS.append(KILOGRAM_FORCE_METRE)
KILOGRAM_FORCE_METRE_PER_SECOND = UnitDescriptor(
    'kilogram-force metre per second', 'B39', """kgf·m/s"""
)
...
KILOGRAM_FORCE_PER_SQUARE_METRE = UnitDescriptor(
    'kilogram-force per square metre', 'B40', """kgf/m²"""
)
...
KILOJOULE_PER_KILOGRAM = UnitDescriptor(
    'kilojoule per kilogram', 'B42', """kJ/kg"""
)
ALL_UNITS.append(KILOJOULE_PER_KILOGRAM)
KILOJOULE_PER_KILOGRAM_KELVIN = UnitDescriptor(
    'kilojoule per kilogram kelvin', 'B43', """kJ/(kg·K)"""
)
...
KILOMOLE_PER_CUBIC_METRE = UnitDescriptor(
    'kilomole per cubic metre', 'B46', """kmol/m³"""
)
...
KILOSIEMENS_PER_METRE = UnitDescriptor(
    'kilosiemens per metre', 'B54', """kS/m"""
)
...
LUMEN_PER_SQUARE_METRE = UnitDescriptor(
    'lumen per square metre', 'B60', """lm/m²"""
)
...
MEGAAMPERE_PER_SQUARE_METRE = UnitDescriptor(
    'megaampere per square metre', 'B66', """MA/m²"""
)
ALL_UNITS.append(MEGAAMPERE_PER_SQUARE_METRE)
MEGABECQUEREL_PER_KILOGRAM = UnitDescriptor(
    'megabecquerel per kilogram', 'B67', """MBq/kg"""
)
ALL_UNITS.append(MEGABECQUEREL_PER_KILOGRAM)
GIGABIT = UnitDescriptor('gigabit', 'B68', """Gbit""")
ALL_UNITS.append(GIGABIT)
MEGACOULOMB_PER_CUBIC_METRE = UnitDescriptor(
    'megacoulomb per cubic metre', 'B69', """MC/m³"""
)
ALL_UNITS.append(MEGACOULOMB_PER_CUBIC_METRE)
CYCLE = UnitDescriptor('cycle', 'B7', """""")
ALL_UNITS.append(CYCLE)
MEGACOULOMB_PER_SQUARE_METRE = UnitDescriptor(
    'megacoulomb per square metre', 'B70', """MC/m²"""
)
...
MEGAGRAM_PER_CUBIC_METRE = UnitDescriptor(
    'megagram per cubic metre', 'B72', """Mg/m³"""
)
...
MEGASIEMENS_PER_METRE = UnitDescriptor(
    'megasiemens per metre', 'B77', """MS/m"""
)
...
JOULE_PER_CUBIC_METRE = UnitDescriptor(
    'joule per cubic metre', 'B8', """J/m³"""
)
...
RECIPROCAL_METRE_SQUARED_RECIPROCAL_SECOND = UnitDescriptor(
    'reciprocal metre squared reciprocal second', 'B81', """m⁻²/s"""
)
...
METRE_TO_THE_FOURTH_POWER = UnitDescriptor(
    'metre to the fourth power', 'B83', """m⁴"""
)
...
MICROCOULOMB_PER_CUBIC_METRE = UnitDescriptor(
    'microcoulomb per cubic metre', 'B87', """µC/m³"""
)
ALL_UNITS.append(MICROCOULOMB_PER_CUBIC_METRE)
MICROCOULOMB_PER_SQUARE_METRE = UnitDescriptor(
    'microcoulomb per square metre', 'B88', """µC/m²"""
)
...
BAR_UNIT_OF_PRESSURE = UnitDescriptor(
    'bar [unit of pressure]', 'BAR', """bar"""
)
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE = UnitDescriptor(
    'British thermal unit (international table)', 'BTU', """BtuIT"""
)
...
COMPOSITE_PRODUCT_POUND_TOTAL_WEIGHT = UnitDescriptor(
...
MILLIMETRE_PER_SECOND = UnitDescriptor(
    'millimetre per second', 'C16', """mm/s"""
)
ALL_UNITS.append(MILLIMETRE_PER_SECOND)
MILLIMETRE_SQUARED_PER_SECOND = UnitDescriptor(
    'millimetre squared per second', 'C17', """mm²/s"""
)
...
MILLINEWTON_PER_METRE = UnitDescriptor(
    'millinewton per metre', 'C22', """mN/m"""
)
...
MILLIWATT_PER_SQUARE_METRE = UnitDescriptor(
    'milliwatt per square metre', 'C32', """mW/m²"""
)
...
MOLE_PER_CUBIC_DECIMETRE = UnitDescriptor(
    'mole per cubic decimetre', 'C35', """mol/dm³"""
)
ALL_UNITS.append(MOLE_PER_CUBIC_DECIMETRE)
MOLE_PER_CUBIC_METRE = UnitDescriptor(
    'mole per cubic metre', 'C36', """mol/m³"""
)
...
NEWTON_METRE_SQUARED_PER_KILOGRAM_SQUARED = UnitDescriptor(
    'newton metre squared per kilogram squared', 'C54', """N·m²/kg²"""
)
ALL_UNITS.append(NEWTON_METRE_SQUARED_PER_KILOGRAM_SQUARED)
NEWTON_PER_SQUARE_METRE = UnitDescriptor(
    'newton per square metre', 'C55', """N/m²"""
)
ALL_UNITS.append(NEWTON_PER_SQUARE_METRE)
NEWTON_PER_SQUARE_MILLIMETRE = UnitDescriptor(
    'newton per square millimetre', 'C56', """N/mm²"""
)
...
NEWTON_SECOND_PER_METRE = UnitDescriptor(
    'newton second per metre', 'C58', """N·s/m"""
)
...
PASCAL_SECOND_PER_CUBIC_METRE = UnitDescriptor(
    'pascal second per cubic metre', 'C66', """Pa·s/m³"""
)
ALL_UNITS.append(PASCAL_SECOND_PER_CUBIC_METRE)
PASCAL_SECOND_PER_METRE = UnitDescriptor(
    'pascal second per metre', 'C67', """Pa· s/m"""
)
...
PICOWATT_PER_SQUARE_METRE = UnitDescriptor(
    'picowatt per square metre', 'C76', """pW/m²"""
)
...
MILLICOULOMB_PER_KILOGRAM = UnitDescriptor(
    'millicoulomb per kilogram', 'C8', """mC/kg"""
)
...
RADIAN_SQUARE_METRE_PER_MOLE = UnitDescriptor(
    'radian square metre per mole', 'C82', """rad·m²/mol"""
)
ALL_UNITS.append(RADIAN_SQUARE_METRE_PER_MOLE)
RADIAN_SQUARE_METRE_PER_KILOGRAM = UnitDescriptor(
    'radian square metre per kilogram', 'C83', """rad·m²/kg"""
)
...
RECIPROCAL_CUBIC_METRE = UnitDescriptor(
    'reciprocal cubic metre', 'C86', """m⁻³"""
)
ALL_UNITS.append(RECIPROCAL_CUBIC_METRE)
RECIPROCAL_CUBIC_METRE_PER_SECOND = UnitDescriptor(
    'reciprocal cubic metre per second', 'C87', """m⁻³/s"""
)
ALL_UNITS.append(RECIPROCAL_CUBIC_METRE_PER_SECOND)
RECIPROCAL_ELECTRON_VOLT_PER_CUBIC_METRE = UnitDescriptor(
    'reciprocal electron volt per cubic metre', 'C88', """eV⁻¹/m³"""
)
...
RECIPROCAL_JOULE_PER_CUBIC_METRE = UnitDescriptor(
    'reciprocal joule per cubic metre', 'C90', """J⁻¹/m³"""
)
ALL_UNITS.append(RECIPROCAL_JOULE_PER_CUBIC_METRE)
RECIPROCAL_KELVIN_OR_KELVIN_TO_THE_POWER_MINUS_ONE = UnitDescriptor(
    'reciprocal kelvin or kelvin to the power minus one', 'C91', """K⁻¹"""
)
...
RECIPROCAL_SQUARE_METRE = UnitDescriptor(
    'reciprocal square metre', 'C93', """m⁻²"""
)
...
RECIPROCAL_PASCAL_OR_PASCAL_TO_THE_POWER_MINUS_ONE = UnitDescriptor(
    'reciprocal pascal or pascal to the power minus one', 'C96', """Pa⁻¹"""
)
...
RECIPROCAL_SECOND_PER_CUBIC_METRE = UnitDescriptor(
    'reciprocal second per cubic metre', 'C98', """s⁻¹/m³"""
)
ALL_UNITS.append(RECIPROCAL_SECOND_PER_CUBIC_METRE)
RECIPROCAL_SECOND_PER_METRE_SQUARED = UnitDescriptor(
    'reciprocal second per metre squared', 'C99', """s⁻¹/m²"""
)
ALL_UNITS.append(RECIPROCAL_SECOND_PER_METRE_SQUARED)
CAN = UnitDescriptor('can', 'CA', """""")
ALL_UNITS.append(CAN)
CARRYING_CAPACITY_IN_METRIC_TON = UnitDescriptor(
...
HUNDRED_POUND_CWT_PER_HUNDRED_WEIGHT_US = UnitDescriptor(
    'hundred pound (cwt) / hundred weight (US)', 'CWA', """cwt (US)"""
)
...
KILOWATT_HOUR_PER_HOUR = UnitDescriptor(
    'kilowatt hour per hour', 'D03', """kW·h/h"""
)
...
RECIPROCAL_SECOND_PER_STERADIAN = UnitDescriptor(
    'reciprocal second per steradian', 'D1', """s⁻¹/sr"""
)
...
SIEMENS_SQUARE_METRE_PER_MOLE = UnitDescriptor(
    'siemens square metre per mole', 'D12', """S·m²/mol"""
)
...
SQUARE_CENTIMETRE_PER_ERG = UnitDescriptor(
    'square centimetre per erg', 'D16', """cm²/erg"""
)
ALL_UNITS.append(SQUARE_CENTIMETRE_PER_ERG)
SQUARE_CENTIMETRE_PER_STERADIAN_ERG = UnitDescriptor(
    'square centimetre per steradian erg', 'D17', """cm²/(sr·erg)"""
)
...
SQUARE_METRE_KELVIN_PER_WATT = UnitDescriptor(
    'square metre kelvin per watt', 'D19', """m²·K/W"""
)
ALL_UNITS.append(SQUARE_METRE_KELVIN_PER_WATT)
RECIPROCAL_SECOND_PER_STERADIAN_METRE_SQUARED = UnitDescriptor(
    'reciprocal second per steradian metre squared', 'D2', """s⁻¹/(sr·m²)"""
)
ALL_UNITS.append(RECIPROCAL_SECOND_PER_STERADIAN_METRE_SQUARED)
SQUARE_METRE_PER_JOULE = UnitDescriptor(
    'square metre per joule', 'D20', """m²/J"""
)
ALL_UNITS.append(SQUARE_METRE_PER_JOULE)
SQUARE_METRE_PER_KILOGRAM = UnitDescriptor(
    'square metre per kilogram', 'D21', """m²/kg"""
)
ALL_UNITS.append(SQUARE_METRE_PER_KILOGRAM)
SQUARE_METRE_PER_MOLE = UnitDescriptor(
    'square metre per mole', 'D22', """m²/mol"""
)
...
SQUARE_METRE_PER_STERADIAN = UnitDescriptor(
    'square metre per steradian', 'D24', """m²/sr"""
)
ALL_UNITS.append(SQUARE_METRE_PER_STERADIAN)
SQUARE_METRE_PER_STERADIAN_JOULE = UnitDescriptor(
    'square metre per steradian joule', 'D25', """m²/(sr·J)"""
)
ALL_UNITS.append(SQUARE_METRE_PER_STERADIAN_JOULE)
SQUARE_METRE_PER_VOLT_SECOND = UnitDescriptor(
    'square metre per volt second', 'D26', """m²/(V·s)"""
)
...
CALORIE_THERMOCHEMICAL = UnitDescriptor(
    'calorie (thermochemical)', 'D35', """calth"""
)
ALL_UNITS.append(CALORIE_THERMOCHEMICAL)
MEGABIT = UnitDescriptor('megabit', 'D36', """Mbit""")
ALL_UNITS.append(MEGABIT)
CALORIE_THERMOCHEMICAL_PER_GRAM_KELVIN = UnitDescriptor(
    'calorie (thermochemical) per gram kelvin', 'D37', """calth/(g·K)"""
)
ALL_UNITS.append(CALORIE_THERMOCHEMICAL_PER_GRAM_KELVIN)
CALORIE_THERMOCHEMICAL_PER_SECOND_CENTIMETRE_KELVIN = UnitDescriptor(
    'calorie (thermochemical) per second centimetre kelvin',
    'D38',
    """calth/(s·cm·K)""",
)
ALL_UNITS.append(CALORIE_THERMOCHEMICAL_PER_SECOND_CENTIMETRE_KELVIN)
CALORIE_THERMOCHEMICAL_PER_SECOND_SQUARE_CENTIMETRE_KELVIN = UnitDescriptor(
...
UNIFIED_ATOMIC_MASS_UNIT = UnitDescriptor(
    'unified atomic mass unit', 'D43', """u"""
)
ALL_UNITS.append(UNIFIED_ATOMIC_MASS_UNIT)
VAR = UnitDescriptor('var', 'D44', """var""")
ALL_UNITS.append(VAR)
VOLT_SQUARED_PER_KELVIN_SQUARED = UnitDescriptor(
    'volt squared per kelvin squared', 'D45', """V²/K²"""
)
...
KILOGRAM_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'kilogram per square centimetre', 'D5', """kg/cm²"""
)
...
WATT_PER_METRE_KELVIN = UnitDescriptor(
    'watt per metre kelvin', 'D53', """W/(m·K)"""
)
ALL_UNITS.append(WATT_PER_METRE_KELVIN)
WATT_PER_SQUARE_METRE = UnitDescriptor(
    'watt per square metre', 'D54', """W/m²"""
)
ALL_UNITS.append(WATT_PER_SQUARE_METRE)
WATT_PER_SQUARE_METRE_KELVIN = UnitDescriptor(
    'watt per square metre kelvin', 'D55', """W/(m²·K)"""
)
ALL_UNITS.append(WATT_PER_SQUARE_METRE_KELVIN)
WATT_PER_SQUARE_METRE_KELVIN_TO_THE_FOURTH_POWER = UnitDescriptor(
    'watt per square metre kelvin to the fourth power', 'D56', """W/(m²·K⁴)"""
)
...
WATT_PER_STERADIAN_SQUARE_METRE = UnitDescriptor(
    'watt per steradian square metre', 'D58', """W/(sr·m²)"""
)
...
WEBER_PER_MILLIMETRE = UnitDescriptor(
    'weber per millimetre', 'D60', """Wb/mm"""
)
...
INCH_TO_THE_FOURTH_POWER = UnitDescriptor(
    'inch to the fourth power', 'D69', """in⁴"""
)
ALL_UNITS.append(INCH_TO_THE_FOURTH_POWER)
SANDWICH = UnitDescriptor('sandwich', 'D7', """""")
ALL_UNITS.append(SANDWICH)
CALORIE_INTERNATIONAL_TABLE = UnitDescriptor(
    'calorie (international table)', 'D70', """calIT"""
)
ALL_UNITS.append(CALORIE_INTERNATIONAL_TABLE)
CALORIE_INTERNATIONAL_TABLE_PER_SECOND_CENTIMETRE_KELVIN = UnitDescriptor(
...
CALORIE_INTERNATIONAL_TABLE_PER_SECOND_SQUARE_CENTIMETRE_KELVIN = (
    UnitDescriptor(
...
CALORIE_INTERNATIONAL_TABLE_PER_GRAM = UnitDescriptor(
    'calorie (international table) per gram', 'D75', """calIT/g"""
)
ALL_UNITS.append(CALORIE_INTERNATIONAL_TABLE_PER_GRAM)
CALORIE_INTERNATIONAL_TABLE_PER_GRAM_KELVIN = UnitDescriptor(
    'calorie (international table) per gram kelvin', 'D76', """calIT/(g·K)"""
)
...
MICROWATT_PER_SQUARE_METRE = UnitDescriptor(
    'microwatt per square metre', 'D85', """µW/m²"""
)
ALL_UNITS.append(MICROWATT_PER_SQUARE_METRE)
MILLICOULOMB = UnitDescriptor('millicoulomb', 'D86', """mC""")
ALL_UNITS.append(MILLICOULOMB)
MILLIMOLE_PER_KILOGRAM = UnitDescriptor(
    'millimole per kilogram', 'D87', """mmol/kg"""
)
ALL_UNITS.append(MILLIMOLE_PER_KILOGRAM)
MILLICOULOMB_PER_CUBIC_METRE = UnitDescriptor(
    'millicoulomb per cubic metre', 'D88', """mC/m³"""
)
ALL_UNITS.append(MILLICOULOMB_PER_CUBIC_METRE)
MILLICOULOMB_PER_SQUARE_METRE = UnitDescriptor(
    'millicoulomb per square metre', 'D89', """mC/m²"""
)
ALL_UNITS.append(MILLICOULOMB_PER_SQUARE_METRE)
DYNE_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'dyne per square centimetre', 'D9', """dyn/cm²"""
)
...
SECOND_PER_CUBIC_METRE = UnitDescriptor(
    'second per cubic metre', 'D93', """s/m³"""
)
ALL_UNITS.append(SECOND_PER_CUBIC_METRE)
SECOND_PER_CUBIC_METRE_RADIAN = UnitDescriptor(
    'second per cubic metre radian', 'D94', """s/(rad·m³)"""
)
...
NEWTON_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'newton per square centimetre', 'E01', """N/cm²"""
)
ALL_UNITS.append(NEWTON_PER_SQUARE_CENTIMETRE)
MEGAWATT_HOUR_PER_HOUR = UnitDescriptor(
    'megawatt hour per hour', 'E07', """MW·h/h"""
)
...
KILOCALORIE_INTERNATIONAL_TABLE = UnitDescriptor(
    'kilocalorie (international table)', 'E14', """kcalIT"""
)
ALL_UNITS.append(KILOCALORIE_INTERNATIONAL_TABLE)
KILOCALORIE_THERMOCHEMICAL_PER_HOUR = UnitDescriptor(
    'kilocalorie (thermochemical) per hour', 'E15', """kcalth/h"""
)
ALL_UNITS.append(KILOCALORIE_THERMOCHEMICAL_PER_HOUR)
MILLION_BTUIT_PER_HOUR = UnitDescriptor(
    'million Btu(IT) per hour', 'E16', """BtuIT/h"""
)
ALL_UNITS.append(MILLION_BTUIT_PER_HOUR)
CUBIC_FOOT_PER_SECOND = UnitDescriptor(
    'cubic foot per second', 'E17', """ft³/s"""
)
...
SQUARE_METRE_PER_LITRE = UnitDescriptor(
    'square metre per litre', 'E31', """m²/l"""
)
...
PART_PER_HUNDRED_THOUSAND = UnitDescriptor(
    'part per hundred thousand', 'E40', """ppht"""
)
ALL_UNITS.append(PART_PER_HUNDRED_THOUSAND)
KILOGRAM_FORCE_PER_SQUARE_MILLIMETRE = UnitDescriptor(
    'kilogram-force per square millimetre', 'E41', """kgf/mm²"""
)
ALL_UNITS.append(KILOGRAM_FORCE_PER_SQUARE_MILLIMETRE)
KILOGRAM_FORCE_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'kilogram-force per square centimetre', 'E42', """kgf/cm²"""
)
ALL_UNITS.append(KILOGRAM_FORCE_PER_SQUARE_CENTIMETRE)
JOULE_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'joule per square centimetre', 'E43', """J/cm²"""
)
ALL_UNITS.append(JOULE_PER_SQUARE_CENTIMETRE)
KILOGRAM_FORCE_METRE_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'kilogram-force metre per square centimetre', 'E44', """kgf·m/cm²"""
)
...
KILOWATT_HOUR_PER_CUBIC_METRE = UnitDescriptor(
    'kilowatt hour per cubic metre', 'E46', """kW·h/m³"""
)
ALL_UNITS.append(KILOWATT_HOUR_PER_CUBIC_METRE)
KILOWATT_HOUR_PER_KELVIN = UnitDescriptor(
    'kilowatt hour per kelvin', 'E47', """kW·h/K"""
)
...
EXBIBIT_PER_SQUARE_METRE = UnitDescriptor(
    'exbibit per square metre', 'E66', """Eibit/m²"""
)
ALL_UNITS.append(EXBIBIT_PER_SQUARE_METRE)
EXBIBIT_PER_CUBIC_METRE = UnitDescriptor(
    'exbibit per cubic metre', 'E67', """Eibit/m³"""
)
ALL_UNITS.append(EXBIBIT_PER_CUBIC_METRE)
GIGABYTE_PER_SECOND = UnitDescriptor(
    'gigabyte per second', 'E68', """Gbyte/s"""
)
...
GIBIBIT_PER_SQUARE_METRE = UnitDescriptor(
    'gibibit per square metre', 'E70', """Gibit/m²"""
)
ALL_UNITS.append(GIBIBIT_PER_SQUARE_METRE)
GIBIBIT_PER_CUBIC_METRE = UnitDescriptor(
    'gibibit per cubic metre', 'E71', """Gibit/m³"""
)
...
KIBIBIT_PER_SQUARE_METRE = UnitDescriptor(
    'kibibit per square metre', 'E73', """Kibit/m²"""
)
ALL_UNITS.append(KIBIBIT_PER_SQUARE_METRE)
KIBIBIT_PER_CUBIC_METRE = UnitDescriptor(
    'kibibit per cubic metre', 'E74', """Kibit/m³"""
)
...
MEBIBIT_PER_SQUARE_METRE = UnitDescriptor(
    'mebibit per square metre', 'E76', """Mibit/m²"""
)
ALL_UNITS.append(MEBIBIT_PER_SQUARE_METRE)
MEBIBIT_PER_CUBIC_METRE = UnitDescriptor(
    'mebibit per cubic metre', 'E77', """Mibit/m³"""
)
...
PEBIBIT_PER_SQUARE_METRE = UnitDescriptor(
    'pebibit per square metre', 'E81', """Pibit/m²"""
)
ALL_UNITS.append(PEBIBIT_PER_SQUARE_METRE)
PEBIBIT_PER_CUBIC_METRE = UnitDescriptor(
    'pebibit per cubic metre', 'E82', """Pibit/m³"""
)
...
TEBIBIT_PER_CUBIC_METRE = UnitDescriptor(
    'tebibit per cubic metre', 'E86', """Tibit/m³"""
)
ALL_UNITS.append(TEBIBIT_PER_CUBIC_METRE)
TEBIBIT_PER_SQUARE_METRE = UnitDescriptor(
    'tebibit per square metre', 'E87', """Tibit/m²"""
)
...
BIT_PER_SQUARE_METRE = UnitDescriptor(
    'bit per square metre', 'E89', """bit/m²"""
)
ALL_UNITS.append(BIT_PER_SQUARE_METRE)
RECIPROCAL_CENTIMETRE = UnitDescriptor(
    'reciprocal centimetre', 'E90', """cm⁻¹"""
)
ALL_UNITS.append(RECIPROCAL_CENTIMETRE)
RECIPROCAL_DAY = UnitDescriptor('reciprocal day', 'E91', """d⁻¹""")
ALL_UNITS.append(RECIPROCAL_DAY)
CUBIC_DECIMETRE_PER_HOUR = UnitDescriptor(
    'cubic decimetre per hour', 'E92', """dm³/h"""
)
...
MILLIMETRE_PER_DEGREE_CELCIUS_METRE = UnitDescriptor(
    'millimetre per degree Celcius metre', 'E97', """mm/(°C·m)"""
)
ALL_UNITS.append(MILLIMETRE_PER_DEGREE_CELCIUS_METRE)
DEGREE_CELSIUS_PER_KELVIN = UnitDescriptor(
    'degree Celsius per kelvin', 'E98', """°C/K"""
)
ALL_UNITS.append(DEGREE_CELSIUS_PER_KELVIN)
HECTOPASCAL_PER_BAR = UnitDescriptor(
    'hectopascal per bar', 'E99', """hPa/bar"""
)
...
MILLIAMPERE_PER_INCH = UnitDescriptor(
    'milliampere per inch', 'F08', """mA/in"""
)
ALL_UNITS.append(MILLIAMPERE_PER_INCH)
THOUSAND_CUBIC_FOOT_PER_DAY = UnitDescriptor(
    'thousand cubic foot per day', 'F1', """"""
)
...
POUND_FORCE_PER_FOOT = UnitDescriptor(
    'pound-force per foot', 'F17', """lbf/ft"""
)
ALL_UNITS.append(POUND_FORCE_PER_FOOT)
KILOGRAM_SQUARE_CENTIMETRE = UnitDescriptor(
    'kilogram square centimetre', 'F18', """kg·cm²"""
)
ALL_UNITS.append(KILOGRAM_SQUARE_CENTIMETRE)
KILOGRAM_SQUARE_MILLIMETRE = UnitDescriptor(
    'kilogram square millimetre', 'F19', """kg·mm²"""
)
...
POUND_FORCE_FOOT_PER_AMPERE = UnitDescriptor(
    'pound-force foot per ampere', 'F22', """lbf·ft/A"""
)
ALL_UNITS.append(POUND_FORCE_FOOT_PER_AMPERE)
GRAM_PER_CUBIC_DECIMETRE = UnitDescriptor(
    'gram per cubic decimetre', 'F23', """g/dm³"""
)
ALL_UNITS.append(GRAM_PER_CUBIC_DECIMETRE)
KILOGRAM_PER_KILOMOL = UnitDescriptor(
    'kilogram per kilomol', 'F24', """kg/kmol"""
)
...
MILLIGRAM_PER_MINUTE = UnitDescriptor(
    'milligram per minute', 'F33', """mg/min"""
)
...
GRAM_PER_DAY_KELVIN = UnitDescriptor(
    'gram per day kelvin', 'F35', """g/(d·K)"""
)
ALL_UNITS.append(GRAM_PER_DAY_KELVIN)
GRAM_PER_HOUR_KELVIN = UnitDescriptor(
    'gram per hour kelvin', 'F36', """g/(h·K)"""
)
ALL_UNITS.append(GRAM_PER_HOUR_KELVIN)
GRAM_PER_MINUTE_KELVIN = UnitDescriptor(
    'gram per minute kelvin', 'F37', """g/(min·K)"""
)
ALL_UNITS.append(GRAM_PER_MINUTE_KELVIN)
GRAM_PER_SECOND_KELVIN = UnitDescriptor(
    'gram per second kelvin', 'F38', """g/(s·K)"""
)
ALL_UNITS.append(GRAM_PER_SECOND_KELVIN)
KILOGRAM_PER_DAY_KELVIN = UnitDescriptor(
    'kilogram per day kelvin', 'F39', """kg/(d·K)"""
)
ALL_UNITS.append(KILOGRAM_PER_DAY_KELVIN)
KILOGRAM_PER_HOUR_KELVIN = UnitDescriptor(
    'kilogram per hour kelvin', 'F40', """kg/(h·K)"""
)
ALL_UNITS.append(KILOGRAM_PER_HOUR_KELVIN)
KILOGRAM_PER_MINUTE_KELVIN = UnitDescriptor(
    'kilogram per minute kelvin', 'F41', """kg/(min·K)"""
)
ALL_UNITS.append(KILOGRAM_PER_MINUTE_KELVIN)
KILOGRAM_PER_SECOND_KELVIN = UnitDescriptor(
    'kilogram per second kelvin', 'F42', """kg/(s·K)"""
)
ALL_UNITS.append(KILOGRAM_PER_SECOND_KELVIN)
MILLIGRAM_PER_DAY_KELVIN = UnitDescriptor(
    'milligram per day kelvin', 'F43', """mg/(d·K)"""
)
ALL_UNITS.append(MILLIGRAM_PER_DAY_KELVIN)
MILLIGRAM_PER_HOUR_KELVIN = UnitDescriptor(
    'milligram per hour kelvin', 'F44', """mg/(h·K)"""
)
ALL_UNITS.append(MILLIGRAM_PER_HOUR_KELVIN)
MILLIGRAM_PER_MINUTE_KELVIN = UnitDescriptor(
    'milligram per minute kelvin', 'F45', """mg/(min·K)"""
)
ALL_UNITS.append(MILLIGRAM_PER_MINUTE_KELVIN)
MILLIGRAM_PER_SECOND_KELVIN = UnitDescriptor(
    'milligram per second kelvin', 'F46', """mg/(s·K)"""
)
ALL_UNITS.append(MILLIGRAM_PER_SECOND_KELVIN)
NEWTON_PER_MILLIMETRE = UnitDescriptor(
    'newton per millimetre', 'F47', """N/mm"""
)
ALL_UNITS.append(NEWTON_PER_MILLIMETRE)
POUND_FORCE_PER_INCH = UnitDescriptor(
    'pound-force per inch', 'F48', """lbf/in"""
)
ALL_UNITS.append(POUND_FORCE_PER_INCH)
ROD_UNIT_OF_DISTANCE = UnitDescriptor(
    'rod [unit of distance]', 'F49', """rd (US)"""
)
ALL_UNITS.append(ROD_UNIT_OF_DISTANCE)
MICROMETRE_PER_KELVIN = UnitDescriptor(
    'micrometre per kelvin', 'F50', """µm/K"""
)
ALL_UNITS.append(MICROMETRE_PER_KELVIN)
CENTIMETRE_PER_KELVIN = UnitDescriptor(
    'centimetre per kelvin', 'F51', """cm/K"""
)
...
MILLIMETRE_PER_KELVIN = UnitDescriptor(
    'millimetre per kelvin', 'F53', """mm/K"""
)
...
OHM_PER_MILE_STATUTE_MILE = UnitDescriptor(
    'ohm per mile (statute mile)', 'F55', """Ω/mi"""
)
...
MILLIAMPERE_PER_POUND_FORCE_PER_SQUARE_INCH = UnitDescriptor(
    'milliampere per pound-force per square inch', 'F57', """mA/(lbf/in²)"""
)
...
DEGREE_CELSIUS_PER_BAR = UnitDescriptor(
    'degree Celsius per bar', 'F60', """°C/bar"""
)
...
GRAM_PER_MINUTE_BAR = UnitDescriptor(
    'gram per minute bar', 'F64', """g/(min·bar)"""
)
ALL_UNITS.append(GRAM_PER_MINUTE_BAR)
GRAM_PER_SECOND_BAR = UnitDescriptor(
    'gram per second bar', 'F65', """g/(s·bar)"""
)
ALL_UNITS.append(GRAM_PER_SECOND_BAR)
KILOGRAM_PER_DAY_BAR = UnitDescriptor(
    'kilogram per day bar', 'F66', """kg/(d·bar)"""
)
ALL_UNITS.append(KILOGRAM_PER_DAY_BAR)
KILOGRAM_PER_HOUR_BAR = UnitDescriptor(
    'kilogram per hour bar', 'F67', """kg/(h·bar)"""
)
ALL_UNITS.append(KILOGRAM_PER_HOUR_BAR)
KILOGRAM_PER_MINUTE_BAR = UnitDescriptor(
    'kilogram per minute bar', 'F68', """kg/(min·bar)"""
)
ALL_UNITS.append(KILOGRAM_PER_MINUTE_BAR)
KILOGRAM_PER_SECOND_BAR = UnitDescriptor(
    'kilogram per second bar', 'F69', """kg/(s·bar)"""
)
ALL_UNITS.append(KILOGRAM_PER_SECOND_BAR)
MILLIGRAM_PER_DAY_BAR = UnitDescriptor(
    'milligram per day bar', 'F70', """mg/(d·bar)"""
)
ALL_UNITS.append(MILLIGRAM_PER_DAY_BAR)
MILLIGRAM_PER_HOUR_BAR = UnitDescriptor(
    'milligram per hour bar', 'F71', """mg/(h·bar)"""
)
ALL_UNITS.append(MILLIGRAM_PER_HOUR_BAR)
MILLIGRAM_PER_MINUTE_BAR = UnitDescriptor(
    'milligram per minute bar', 'F72', """mg/(min·bar)"""
)
ALL_UNITS.append(MILLIGRAM_PER_MINUTE_BAR)
MILLIGRAM_PER_SECOND_BAR = UnitDescriptor(
    'milligram per second bar', 'F73', """mg/(s·bar)"""
)
...
MILLIAMPERE_PER_MILLIMETRE = UnitDescriptor(
    'milliampere per millimetre', 'F76', """mA/mm"""
)
ALL_UNITS.append(MILLIAMPERE_PER_MILLIMETRE)
PASCAL_SECOND_PER_KELVIN = UnitDescriptor(
    'pascal second per kelvin', 'F77', """Pa.s/K"""
)
...
HECTOPASCAL_PER_KELVIN = UnitDescriptor(
    'hectopascal per kelvin', 'F82', """hPa/K"""
)
ALL_UNITS.append(HECTOPASCAL_PER_KELVIN)
KILOPASCAL_PER_KELVIN = UnitDescriptor(
    'kilopascal per kelvin', 'F83', """kPa/K"""
)
...
MEGAPASCAL_PER_KELVIN = UnitDescriptor(
    'megapascal per kelvin', 'F85', """MPa/K"""
)
...
VOLT_PER_LITRE_MINUTE = UnitDescriptor(
    'volt per litre minute', 'F87', """V/(l·min)"""
)
...
NEWTON_METRE_PER_DEGREE = UnitDescriptor(
    'newton metre per degree', 'F89', """Nm/°"""
)
ALL_UNITS.append(NEWTON_METRE_PER_DEGREE)
FIBRE_PER_CUBIC_CENTIMETRE_OF_AIR = UnitDescriptor(
    'fibre per cubic centimetre of air', 'F9', """"""
)
ALL_UNITS.append(FIBRE_PER_CUBIC_CENTIMETRE_OF_AIR)
NEWTON_METRE_PER_AMPERE = UnitDescriptor(
    'newton metre per ampere', 'F90', """N·m/A"""
)
ALL_UNITS.append(NEWTON_METRE_PER_AMPERE)
BAR_LITRE_PER_SECOND = UnitDescriptor(
    'bar litre per second', 'F91', """bar·l/s"""
)
ALL_UNITS.append(BAR_LITRE_PER_SECOND)
BAR_CUBIC_METRE_PER_SECOND = UnitDescriptor(
    'bar cubic metre per second', 'F92', """bar·m³/s"""
)
ALL_UNITS.append(BAR_CUBIC_METRE_PER_SECOND)
HECTOPASCAL_LITRE_PER_SECOND = UnitDescriptor(
    'hectopascal litre per second', 'F93', """hPa·l/s"""
)
ALL_UNITS.append(HECTOPASCAL_LITRE_PER_SECOND)
HECTOPASCAL_CUBIC_METRE_PER_SECOND = UnitDescriptor(
    'hectopascal cubic metre per second', 'F94', """hPa·m³/s"""
)
ALL_UNITS.append(HECTOPASCAL_CUBIC_METRE_PER_SECOND)
MILLIBAR_LITRE_PER_SECOND = UnitDescriptor(
    'millibar litre per second', 'F95', """mbar·l/s"""
)
ALL_UNITS.append(MILLIBAR_LITRE_PER_SECOND)
MILLIBAR_CUBIC_METRE_PER_SECOND = UnitDescriptor(
    'millibar cubic metre per second', 'F96', """mbar·m³/s"""
)
ALL_UNITS.append(MILLIBAR_CUBIC_METRE_PER_SECOND)
MEGAPASCAL_LITRE_PER_SECOND = UnitDescriptor(
    'megapascal litre per second', 'F97', """MPa·l/s"""
)
ALL_UNITS.append(MEGAPASCAL_LITRE_PER_SECOND)
MEGAPASCAL_CUBIC_METRE_PER_SECOND = UnitDescriptor(
    'megapascal cubic metre per second', 'F98', """MPa·m³/s"""
)
ALL_UNITS.append(MEGAPASCAL_CUBIC_METRE_PER_SECOND)
PASCAL_LITRE_PER_SECOND = UnitDescriptor(
    'pascal litre per second', 'F99', """Pa·l/s"""
)
...
MILLION_PARTICLE_PER_CUBIC_FOOT = UnitDescriptor(
...
POUND_PER_SQUARE_FOOT = UnitDescriptor(
    'pound per square foot', 'FP', """lb/ft²"""
)
...
PASCAL_CUBIC_METRE_PER_SECOND = UnitDescriptor(
    'pascal cubic metre per second', 'G01', """Pa·m³/s"""
)
...
SQUARE_INCH_PER_SECOND = UnitDescriptor(
    'square inch per second', 'G08', """in²/s"""
)
ALL_UNITS.append(SQUARE_INCH_PER_SECOND)
SQUARE_METRE_PER_SECOND_KELVIN = UnitDescriptor(
    'square metre per second kelvin', 'G09', """m²/(s·K)"""
)
...
GRAM_PER_CUBIC_CENTIMETRE_BAR = UnitDescriptor(
    'gram per cubic centimetre bar', 'G11', """g/(cm³·bar)"""
)
ALL_UNITS.append(GRAM_PER_CUBIC_CENTIMETRE_BAR)
GRAM_PER_CUBIC_DECIMETRE_BAR = UnitDescriptor(
    'gram per cubic decimetre bar', 'G12', """g/(dm³·bar)"""
)
ALL_UNITS.append(GRAM_PER_CUBIC_DECIMETRE_BAR)
GRAM_PER_LITRE_BAR = UnitDescriptor(
    'gram per litre bar', 'G13', """g/(l·bar)"""
)
ALL_UNITS.append(GRAM_PER_LITRE_BAR)
GRAM_PER_CUBIC_METRE_BAR = UnitDescriptor(
    'gram per cubic metre bar', 'G14', """g/(m³·bar)"""
)
ALL_UNITS.append(GRAM_PER_CUBIC_METRE_BAR)
GRAM_PER_MILLILITRE_BAR = UnitDescriptor(
    'gram per millilitre bar', 'G15', """g/(ml·bar)"""
)
ALL_UNITS.append(GRAM_PER_MILLILITRE_BAR)
KILOGRAM_PER_CUBIC_CENTIMETRE_BAR = UnitDescriptor(
    'kilogram per cubic centimetre bar', 'G16', """kg/(cm³·bar)"""
)
ALL_UNITS.append(KILOGRAM_PER_CUBIC_CENTIMETRE_BAR)
KILOGRAM_PER_LITRE_BAR = UnitDescriptor(
    'kilogram per litre bar', 'G17', """kg/(l·bar)"""
)
ALL_UNITS.append(KILOGRAM_PER_LITRE_BAR)
KILOGRAM_PER_CUBIC_METRE_BAR = UnitDescriptor(
    'kilogram per cubic metre bar', 'G18', """kg/(m³·bar)"""
)
ALL_UNITS.append(KILOGRAM_PER_CUBIC_METRE_BAR)
NEWTON_METRE_PER_KILOGRAM = UnitDescriptor(
    'newton metre per kilogram', 'G19', """N·m/kg"""
)
ALL_UNITS.append(NEWTON_METRE_PER_KILOGRAM)
US_GALLON_PER_MINUTE = UnitDescriptor(
    'US gallon per minute', 'G2', """gal (US) /min"""
)
ALL_UNITS.append(US_GALLON_PER_MINUTE)
POUND_FORCE_FOOT_PER_POUND = UnitDescriptor(
    'pound-force foot per pound', 'G20', """lbf·ft/lb"""
)
ALL_UNITS.append(POUND_FORCE_FOOT_PER_POUND)
CUP_UNIT_OF_VOLUME = UnitDescriptor(
    'cup [unit of volume]', 'G21', """cup (US)"""
)
...
CUBIC_CENTIMETRE_PER_KELVIN = UnitDescriptor(
    'cubic centimetre per kelvin', 'G27', """cm³/K"""
)
...
CUBIC_METRE_PER_KELVIN = UnitDescriptor(
    'cubic metre per kelvin', 'G29', """m³/K"""
)
ALL_UNITS.append(CUBIC_METRE_PER_KELVIN)
IMPERIAL_GALLON_PER_MINUTE = UnitDescriptor(
    'Imperial gallon per minute', 'G3', """gal (UK) /min"""
)
ALL_UNITS.append(IMPERIAL_GALLON_PER_MINUTE)
MILLILITRE_PER_KELVIN = UnitDescriptor(
    'millilitre per kelvin', 'G30', """ml/K"""
)
ALL_UNITS.append(MILLILITRE_PER_KELVIN)
KILOGRAM_PER_CUBIC_CENTIMETRE = UnitDescriptor(
    'kilogram per cubic centimetre', 'G31', """kg/cm³"""
)
ALL_UNITS.append(KILOGRAM_PER_CUBIC_CENTIMETRE)
OUNCE_AVOIRDUPOIS_PER_CUBIC_YARD = UnitDescriptor(
    'ounce (avoirdupois) per cubic yard', 'G32', """oz/yd³"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_CUBIC_YARD)
GRAM_PER_CUBIC_CENTIMETRE_KELVIN = UnitDescriptor(
    'gram per cubic centimetre kelvin', 'G33', """g/(cm³·K)"""
)
ALL_UNITS.append(GRAM_PER_CUBIC_CENTIMETRE_KELVIN)
GRAM_PER_CUBIC_DECIMETRE_KELVIN = UnitDescriptor(
    'gram per cubic decimetre kelvin', 'G34', """g/(dm³·K)"""
)
ALL_UNITS.append(GRAM_PER_CUBIC_DECIMETRE_KELVIN)
GRAM_PER_LITRE_KELVIN = UnitDescriptor(
    'gram per litre kelvin', 'G35', """g/(l·K)"""
)
ALL_UNITS.append(GRAM_PER_LITRE_KELVIN)
GRAM_PER_CUBIC_METRE_KELVIN = UnitDescriptor(
    'gram per cubic metre kelvin', 'G36', """g/(m³·K)"""
)
ALL_UNITS.append(GRAM_PER_CUBIC_METRE_KELVIN)
GRAM_PER_MILLILITRE_KELVIN = UnitDescriptor(
    'gram per millilitre kelvin', 'G37', """g/(ml·K)"""
)
ALL_UNITS.append(GRAM_PER_MILLILITRE_KELVIN)
KILOGRAM_PER_CUBIC_CENTIMETRE_KELVIN = UnitDescriptor(
    'kilogram per cubic centimetre kelvin', 'G38', """kg/(cm³·K)"""
)
ALL_UNITS.append(KILOGRAM_PER_CUBIC_CENTIMETRE_KELVIN)
KILOGRAM_PER_LITRE_KELVIN = UnitDescriptor(
    'kilogram per litre kelvin', 'G39', """kg/(l·K)"""
)
ALL_UNITS.append(KILOGRAM_PER_LITRE_KELVIN)
KILOGRAM_PER_CUBIC_METRE_KELVIN = UnitDescriptor(
    'kilogram per cubic metre kelvin', 'G40', """kg/(m³·K)"""
)
ALL_UNITS.append(KILOGRAM_PER_CUBIC_METRE_KELVIN)
SQUARE_METRE_PER_SECOND_BAR = UnitDescriptor(
    'square metre per second bar', 'G41', """m²/(s·bar)"""
)
ALL_UNITS.append(SQUARE_METRE_PER_SECOND_BAR)
MICROSIEMENS_PER_CENTIMETRE = UnitDescriptor(
    'microsiemens per centimetre', 'G42', """µS/cm"""
)
ALL_UNITS.append(MICROSIEMENS_PER_CENTIMETRE)
MICROSIEMENS_PER_METRE = UnitDescriptor(
    'microsiemens per metre', 'G43', """µS/m"""
)
ALL_UNITS.append(MICROSIEMENS_PER_METRE)
NANOSIEMENS_PER_CENTIMETRE = UnitDescriptor(
    'nanosiemens per centimetre', 'G44', """nS/cm"""
)
ALL_UNITS.append(NANOSIEMENS_PER_CENTIMETRE)
NANOSIEMENS_PER_METRE = UnitDescriptor(
    'nanosiemens per metre', 'G45', """nS/m"""
)
...
CUBIC_CENTIMETRE_PER_DAY = UnitDescriptor(
    'cubic centimetre per day', 'G47', """cm³/d"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_DAY)
CUBIC_CENTIMETRE_PER_HOUR = UnitDescriptor(
    'cubic centimetre per hour', 'G48', """cm³/h"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_HOUR)
CUBIC_CENTIMETRE_PER_MINUTE = UnitDescriptor(
    'cubic centimetre per minute', 'G49', """cm³/min"""
)
...
CUBIC_METRE_PER_MINUTE = UnitDescriptor(
    'cubic metre per minute', 'G53', """m³/min"""
)
...
CUBIC_INCH_PER_MINUTE = UnitDescriptor(
    'cubic inch per minute', 'G57', """in³/min"""
)
ALL_UNITS.append(CUBIC_INCH_PER_MINUTE)
CUBIC_INCH_PER_SECOND = UnitDescriptor(
    'cubic inch per second', 'G58', """in³/s"""
)
ALL_UNITS.append(CUBIC_INCH_PER_SECOND)
MILLIAMPERE_PER_LITRE_MINUTE = UnitDescriptor(
    'milliampere per litre minute', 'G59', """mA/(l·min)"""
)
...
CUBIC_CENTIMETRE_PER_DAY_KELVIN = UnitDescriptor(
    'cubic centimetre per day kelvin', 'G61', """cm³/(d·K)"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_DAY_KELVIN)
CUBIC_CENTIMETRE_PER_HOUR_KELVIN = UnitDescriptor(
    'cubic centimetre per hour kelvin', 'G62', """cm³/(h·K)"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_HOUR_KELVIN)
CUBIC_CENTIMETRE_PER_MINUTE_KELVIN = UnitDescriptor(
    'cubic centimetre per minute kelvin', 'G63', """cm³/(min·K)"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_MINUTE_KELVIN)
CUBIC_CENTIMETRE_PER_SECOND_KELVIN = UnitDescriptor(
    'cubic centimetre per second kelvin', 'G64', """cm³/(s·K)"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_SECOND_KELVIN)
LITRE_PER_DAY_KELVIN = UnitDescriptor(
    'litre per day kelvin', 'G65', """l/(d·K)"""
)
ALL_UNITS.append(LITRE_PER_DAY_KELVIN)
LITRE_PER_HOUR_KELVIN = UnitDescriptor(
    'litre per hour kelvin', 'G66', """l/(h·K)"""
)
ALL_UNITS.append(LITRE_PER_HOUR_KELVIN)
LITRE_PER_MINUTE_KELVIN = UnitDescriptor(
    'litre per minute kelvin', 'G67', """l/(min·K)"""
)
ALL_UNITS.append(LITRE_PER_MINUTE_KELVIN)
LITRE_PER_SECOND_KELVIN = UnitDescriptor(
    'litre per second kelvin', 'G68', """l/(s·K)"""
)
ALL_UNITS.append(LITRE_PER_SECOND_KELVIN)
CUBIC_METRE_PER_DAY_KELVIN = UnitDescriptor(
    'cubic metre per day kelvin', 'G69', """m³/(d·K)"""
)
...
CUBIC_METRE_PER_HOUR_KELVIN = UnitDescriptor(
    'cubic metre per hour kelvin', 'G70', """m³/(h·K)"""
)
ALL_UNITS.append(CUBIC_METRE_PER_HOUR_KELVIN)
CUBIC_METRE_PER_MINUTE_KELVIN = UnitDescriptor(
    'cubic metre per minute kelvin', 'G71', """m³/(min·K)"""
)
ALL_UNITS.append(CUBIC_METRE_PER_MINUTE_KELVIN)
CUBIC_METRE_PER_SECOND_KELVIN = UnitDescriptor(
    'cubic metre per second kelvin', 'G72', """m³/(s·K)"""
)
ALL_UNITS.append(CUBIC_METRE_PER_SECOND_KELVIN)
MILLILITRE_PER_DAY_KELVIN = UnitDescriptor(
    'millilitre per day kelvin', 'G73', """ml/(d·K)"""
)
ALL_UNITS.append(MILLILITRE_PER_DAY_KELVIN)
MILLILITRE_PER_HOUR_KELVIN = UnitDescriptor(
    'millilitre per hour kelvin', 'G74', """ml/(h·K)"""
)
ALL_UNITS.append(MILLILITRE_PER_HOUR_KELVIN)
MILLILITRE_PER_MINUTE_KELVIN = UnitDescriptor(
    'millilitre per minute kelvin', 'G75', """ml/(min·K)"""
)
ALL_UNITS.append(MILLILITRE_PER_MINUTE_KELVIN)
MILLILITRE_PER_SECOND_KELVIN = UnitDescriptor(
    'millilitre per second kelvin', 'G76', """ml/(s·K)"""
)
ALL_UNITS.append(MILLILITRE_PER_SECOND_KELVIN)
MILLIMETRE_TO_THE_FOURTH_POWER = UnitDescriptor(
    'millimetre to the fourth power', 'G77', """mm⁴"""
)
ALL_UNITS.append(MILLIMETRE_TO_THE_FOURTH_POWER)
CUBIC_CENTIMETRE_PER_DAY_BAR = UnitDescriptor(
    'cubic centimetre per day bar', 'G78', """cm³/(d·bar)"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_DAY_BAR)
CUBIC_CENTIMETRE_PER_HOUR_BAR = UnitDescriptor(
    'cubic centimetre per hour bar', 'G79', """cm³/(h·bar)"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_HOUR_BAR)
CUBIC_CENTIMETRE_PER_MINUTE_BAR = UnitDescriptor(
    'cubic centimetre per minute bar', 'G80', """cm³/(min·bar)"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_MINUTE_BAR)
CUBIC_CENTIMETRE_PER_SECOND_BAR = UnitDescriptor(
    'cubic centimetre per second bar', 'G81', """cm³/(s·bar)"""
)
...
LITRE_PER_HOUR_BAR = UnitDescriptor(
    'litre per hour bar', 'G83', """l/(h·bar)"""
)
ALL_UNITS.append(LITRE_PER_HOUR_BAR)
LITRE_PER_MINUTE_BAR = UnitDescriptor(
    'litre per minute bar', 'G84', """l/(min·bar)"""
)
ALL_UNITS.append(LITRE_PER_MINUTE_BAR)
LITRE_PER_SECOND_BAR = UnitDescriptor(
    'litre per second bar', 'G85', """l/(s·bar)"""
)
ALL_UNITS.append(LITRE_PER_SECOND_BAR)
CUBIC_METRE_PER_DAY_BAR = UnitDescriptor(
    'cubic metre per day bar', 'G86', """m³/(d·bar)"""
)
ALL_UNITS.append(CUBIC_METRE_PER_DAY_BAR)
CUBIC_METRE_PER_HOUR_BAR = UnitDescriptor(
    'cubic metre per hour bar', 'G87', """m³/(h·bar)"""
)
ALL_UNITS.append(CUBIC_METRE_PER_HOUR_BAR)
CUBIC_METRE_PER_MINUTE_BAR = UnitDescriptor(
    'cubic metre per minute bar', 'G88', """m³/(min·bar)"""
)
ALL_UNITS.append(CUBIC_METRE_PER_MINUTE_BAR)
CUBIC_METRE_PER_SECOND_BAR = UnitDescriptor(
    'cubic metre per second bar', 'G89', """m³/(s·bar)"""
)
ALL_UNITS.append(CUBIC_METRE_PER_SECOND_BAR)
MILLILITRE_PER_DAY_BAR = UnitDescriptor(
    'millilitre per day bar', 'G90', """ml/(d·bar)"""
)
ALL_UNITS.append(MILLILITRE_PER_DAY_BAR)
MILLILITRE_PER_HOUR_BAR = UnitDescriptor(
    'millilitre per hour bar', 'G91', """ml/(h·bar)"""
)
ALL_UNITS.append(MILLILITRE_PER_HOUR_BAR)
MILLILITRE_PER_MINUTE_BAR = UnitDescriptor(
    'millilitre per minute bar', 'G92', """ml/(min·bar)"""
)
ALL_UNITS.append(MILLILITRE_PER_MINUTE_BAR)
MILLILITRE_PER_SECOND_BAR = UnitDescriptor(
    'millilitre per second bar', 'G93', """ml/(s·bar)"""
)
ALL_UNITS.append(MILLILITRE_PER_SECOND_BAR)
CUBIC_CENTIMETRE_PER_BAR = UnitDescriptor(
    'cubic centimetre per bar', 'G94', """cm³/bar"""
)
...
MICROHENRY_PER_KILOOHM = UnitDescriptor(
    'microhenry per kiloohm', 'G98', """µH/kΩ"""
)
...
GALLON_US_PER_DAY = UnitDescriptor(
    'gallon (US) per day', 'GB', """gal (US)/d"""
)
...
POUND_PER_GALLON_US = UnitDescriptor(
    'pound per gallon (US)', 'GE', """lb/gal (US)"""
)
ALL_UNITS.append(POUND_PER_GALLON_US)
GRAM_PER_METRE_GRAM_PER_100_CENTIMETRES = UnitDescriptor(
    'gram per metre (gram per 100 centimetres)', 'GF', """g/m"""
)
ALL_UNITS.append(GRAM_PER_METRE_GRAM_PER_100_CENTIMETRES)
GRAM_OF_FISSILE_ISOTOPE = UnitDescriptor(
    'gram of fissile isotope', 'GFI', """gi F/S"""
)
...
GRAM_INCLUDING_CONTAINER = UnitDescriptor(
...
GRAM_INCLUDING_INNER_PACKAGING = UnitDescriptor(
...
GRAM_PER_SQUARE_METRE = UnitDescriptor(
    'gram per square metre', 'GM', """g/m²"""
)
ALL_UNITS.append(GRAM_PER_SQUARE_METRE)
GROSS_GALLON = UnitDescriptor('gross gallon', 'GN', """""")
ALL_UNITS.append(GROSS_GALLON)
MILLIGRAM_PER_SQUARE_METRE = UnitDescriptor(
    'milligram per square metre', 'GO', """mg/m²"""
)
ALL_UNITS.append(MILLIGRAM_PER_SQUARE_METRE)
MILLIGRAM_PER_CUBIC_METRE = UnitDescriptor(
    'milligram per cubic metre', 'GP', """mg/m³"""
)
ALL_UNITS.append(MILLIGRAM_PER_CUBIC_METRE)
MICROGRAM_PER_CUBIC_METRE = UnitDescriptor(
    'microgram per cubic metre', 'GQ', """µg/m³"""
)
...
GALLON_PER_THOUSAND_CUBIC_FOOT = UnitDescriptor(
    'gallon per thousand cubic foot', 'GW', """"""
)
...
MILLIHENRY_PER_KILOOHM = UnitDescriptor(
    'millihenry per kiloohm', 'H05', """mH/kΩ"""
)
...
PASCAL_SECOND_PER_BAR = UnitDescriptor(
    'pascal second per bar', 'H07', """Pa·s/bar"""
)
...
DEGREE_CELSIUS_PER_HOUR = UnitDescriptor(
    'degree Celsius per hour', 'H12', """°C/h"""
)
ALL_UNITS.append(DEGREE_CELSIUS_PER_HOUR)
DEGREE_CELSIUS_PER_MINUTE = UnitDescriptor(
    'degree Celsius per minute', 'H13', """°C/min"""
)
ALL_UNITS.append(DEGREE_CELSIUS_PER_MINUTE)
DEGREE_CELSIUS_PER_SECOND = UnitDescriptor(
    'degree Celsius per second', 'H14', """°C/s"""
)
ALL_UNITS.append(DEGREE_CELSIUS_PER_SECOND)
SQUARE_CENTIMETRE_PER_GRAM = UnitDescriptor(
    'square centimetre per gram', 'H15', """cm²/g"""
)
...
VOLT_SQUARE_INCH_PER_POUND_FORCE = UnitDescriptor(
    'volt square inch per pound-force', 'H22', """V/(lbf/in²)"""
)
...
MICROFARAD_PER_KILOMETRE = UnitDescriptor(
    'microfarad per kilometre', 'H28', """µF/km"""
)
...
SQUARE_MICROMETRE_SQUARE_MICRON = UnitDescriptor(
    'square micrometre (square micron)', 'H30', """µm²"""
)
...
AMPERE_SQUARED_SECOND = UnitDescriptor(
    'ampere squared second', 'H32', """A²·s"""
)
...
KELVIN_METRE_PER_WATT = UnitDescriptor(
    'kelvin metre per watt', 'H35', """K·m/W"""
)
ALL_UNITS.append(KELVIN_METRE_PER_WATT)
MEGAOHM_PER_KILOMETRE = UnitDescriptor(
    'megaohm per kilometre', 'H36', """MΩ/km"""
)
...
NEWTON_METRE_WATT_TO_THE_POWER_MINUS_0_5 = UnitDescriptor(
    'newton metre watt to the power minus 0,5', 'H41', """N·m·W⁻⁰‧⁵"""
)
...
SIEMENS_PER_CENTIMETRE = UnitDescriptor(
    'siemens per centimetre', 'H43', """S/cm"""
)
ALL_UNITS.append(SIEMENS_PER_CENTIMETRE)
TERAOHM = UnitDescriptor('teraohm', 'H44', """TΩ""")
ALL_UNITS.append(TERAOHM)
VOLT_SECOND_PER_METRE = UnitDescriptor(
    'volt second per metre', 'H45', """V·s/m"""
)
...
RECIPROCAL_CUBIC_CENTIMETRE = UnitDescriptor(
    'reciprocal cubic centimetre', 'H50', """cm⁻³"""
)
ALL_UNITS.append(RECIPROCAL_CUBIC_CENTIMETRE)
DECIBEL_PER_KILOMETRE = UnitDescriptor(
    'decibel per kilometre', 'H51', """dB/km"""
)
...
KILOGRAM_PER_CUBIC_DECIMETRE_KELVIN = UnitDescriptor(
    'kilogram per cubic decimetre kelvin', 'H54', """(kg/dm³)/K"""
)
ALL_UNITS.append(KILOGRAM_PER_CUBIC_DECIMETRE_KELVIN)
KILOGRAM_PER_CUBIC_DECIMETRE_BAR = UnitDescriptor(
    'kilogram per cubic decimetre bar', 'H55', """(kg/dm³)/bar"""
)
ALL_UNITS.append(KILOGRAM_PER_CUBIC_DECIMETRE_BAR)
KILOGRAM_PER_SQUARE_METRE_SECOND = UnitDescriptor(
    'kilogram per square metre second', 'H56', """kg/(m²·s)"""
)
ALL_UNITS.append(KILOGRAM_PER_SQUARE_METRE_SECOND)
INCH_PER_TWO_PI_RADIANT = UnitDescriptor(
    'inch per two pi radiant', 'H57', """in/revolution"""
)
ALL_UNITS.append(INCH_PER_TWO_PI_RADIANT)
METRE_PER_VOLT_SECOND = UnitDescriptor(
    'metre per volt second', 'H58', """m/(V·s)"""
)
ALL_UNITS.append(METRE_PER_VOLT_SECOND)
SQUARE_METRE_PER_NEWTON = UnitDescriptor(
    'square metre per newton', 'H59', """m²/N"""
)
ALL_UNITS.append(SQUARE_METRE_PER_NEWTON)
CUBIC_METRE_PER_CUBIC_METRE = UnitDescriptor(
    'cubic metre per cubic metre', 'H60', """m³/m³"""
)
ALL_UNITS.append(CUBIC_METRE_PER_CUBIC_METRE)
MILLISIEMENS_PER_CENTIMETRE = UnitDescriptor(
    'millisiemens per centimetre', 'H61', """mS/cm"""
)
ALL_UNITS.append(MILLISIEMENS_PER_CENTIMETRE)
MILLIVOLT_PER_MINUTE = UnitDescriptor(
    'millivolt per minute', 'H62', """mV/min"""
)
ALL_UNITS.append(MILLIVOLT_PER_MINUTE)
MILLIGRAM_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'milligram per square centimetre', 'H63', """mg/cm²"""
)
...
MILLILITRE_PER_CUBIC_METRE = UnitDescriptor(
    'millilitre per cubic metre', 'H65', """ml/m³"""
)
...
PICOPASCAL_PER_KILOMETRE = UnitDescriptor(
    'picopascal per kilometre', 'H69', """pPa/km"""
)
...
PERCENT_PER_HECTOBAR = UnitDescriptor(
    'percent per hectobar', 'H72', """%/hbar"""
)
ALL_UNITS.append(PERCENT_PER_HECTOBAR)
PERCENT_PER_DECAKELVIN = UnitDescriptor(
    'percent per decakelvin', 'H73', """%/daK"""
)
...
CONVENTIONAL_CENTIMETRE_OF_WATER = UnitDescriptor(
    'conventional centimetre of water', 'H78', """cm H₂O"""
)
...
ALL_UNITS.append(RACK_UNIT)
MILLIMETRE_PER_MINUTE = UnitDescriptor(
    'millimetre per minute', 'H81', """mm/min"""
)
...
PERCENT_PER_TEN_THOUSAND = UnitDescriptor(
    'percent per ten thousand', 'H91', """%/10000"""
)
ALL_UNITS.append(PERCENT_PER_TEN_THOUSAND)
PERCENT_PER_ONE_HUNDRED_THOUSAND = UnitDescriptor(
    'percent per one hundred thousand', 'H92', """%/100000"""
)
...
PERCENT_PER_THOUSAND = UnitDescriptor(
    'percent per thousand', 'H94', """%/1000"""
)
...
HUNDRED_KILOGRAM_DRY_WEIGHT = UnitDescriptor(
...
HUNDRED_INTERNATIONAL_UNIT = UnitDescriptor(
...
HUNDRED_KILOGRAM_NET_MASS = UnitDescriptor(
...
MILE_PER_HOUR_STATUTE_MILE = UnitDescriptor(
    'mile per hour (statute mile)', 'HM', """mile/h"""
)
...
CONVENTIONAL_MILLIMETRE_OF_MERCURY = UnitDescriptor(
    'conventional millimetre of mercury', 'HN', """mm Hg"""
)
...
CONVENTIONAL_MILLIMETRE_OF_WATER = UnitDescriptor(
    'conventional millimetre of water', 'HP', """mm H₂O"""
)
ALL_UNITS.append(CONVENTIONAL_MILLIMETRE_OF_WATER)
HECTOLITRE_OF_PURE_ALCOHOL = UnitDescriptor(
...
INCH_POUND_POUND_INCH = UnitDescriptor(
    'inch pound (pound inch)', 'IA', """in·lb"""
)
...
INTERNATIONAL_SUGAR_DEGREE = UnitDescriptor(
...
INTERNATIONAL_UNIT_PER_GRAM = UnitDescriptor(
    'international unit per gram', 'IUG', """"""
)
ALL_UNITS.append(INTERNATIONAL_UNIT_PER_GRAM)
INCH_PER_SECOND_SQUARED = UnitDescriptor(
    'inch per second squared', 'IV', """in/s²"""
)
ALL_UNITS.append(INCH_PER_SECOND_SQUARED)
PERCENT_PER_MILLIMETRE = UnitDescriptor(
    'percent per millimetre', 'J10', """%/mm"""
)
...
DEGREE_BAUME_ORIGIN_SCALE = UnitDescriptor(
    'degree Baume (origin scale)', 'J14', """°Bé"""
)
ALL_UNITS.append(DEGREE_BAUME_ORIGIN_SCALE)
DEGREE_BAUME_US_HEAVY = UnitDescriptor(
    'degree Baume (US heavy)', 'J15', """°Bé (US heavy)"""
)
ALL_UNITS.append(DEGREE_BAUME_US_HEAVY)
DEGREE_BAUME_US_LIGHT = UnitDescriptor(
    'degree Baume (US light)', 'J16', """°Bé (US light)"""
)
...
DEGREE_FAHRENHEIT_HOUR_SQUARE_FOOT_PER_BRITISH_THERMAL_UNIT_THERMOCHEMICAL = UnitDescriptor(
    (
...
DEGREE_FAHRENHEIT_PER_KELVIN = UnitDescriptor(
    'degree Fahrenheit per kelvin', 'J20', """°F/K"""
)
ALL_UNITS.append(DEGREE_FAHRENHEIT_PER_KELVIN)
DEGREE_FAHRENHEIT_PER_BAR = UnitDescriptor(
    'degree Fahrenheit per bar', 'J21', """°F/bar"""
)
ALL_UNITS.append(DEGREE_FAHRENHEIT_PER_BAR)
DEGREE_FAHRENHEIT_HOUR_SQUARE_FOOT_PER_BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE = UnitDescriptor(
    (
        'degree Fahrenheit hour square foot per British thermal unit'
        ' (international table)'
    ),
...
DEGREE_FAHRENHEIT_PER_HOUR = UnitDescriptor(
    'degree Fahrenheit per hour', 'J23', """°F/h"""
)
ALL_UNITS.append(DEGREE_FAHRENHEIT_PER_HOUR)
DEGREE_FAHRENHEIT_PER_MINUTE = UnitDescriptor(
    'degree Fahrenheit per minute', 'J24', """°F/min"""
)
ALL_UNITS.append(DEGREE_FAHRENHEIT_PER_MINUTE)
DEGREE_FAHRENHEIT_PER_SECOND = UnitDescriptor(
    'degree Fahrenheit per second', 'J25', """°F/s"""
)
ALL_UNITS.append(DEGREE_FAHRENHEIT_PER_SECOND)
RECIPROCAL_DEGREE_FAHRENHEIT = UnitDescriptor(
    'reciprocal degree Fahrenheit', 'J26', """1/°F"""
)
...
DEGREE_RANKINE_PER_HOUR = UnitDescriptor(
    'degree Rankine per hour', 'J28', """°R/h"""
)
ALL_UNITS.append(DEGREE_RANKINE_PER_HOUR)
DEGREE_RANKINE_PER_MINUTE = UnitDescriptor(
    'degree Rankine per minute', 'J29', """°R/min"""
)
ALL_UNITS.append(DEGREE_RANKINE_PER_MINUTE)
DEGREE_RANKINE_PER_SECOND = UnitDescriptor(
    'degree Rankine per second', 'J30', """°R/s"""
)
...
MICROGRAM_PER_KILOGRAM = UnitDescriptor(
    'microgram per kilogram', 'J33', """µg/kg"""
)
ALL_UNITS.append(MICROGRAM_PER_KILOGRAM)
MICROGRAM_PER_CUBIC_METRE_KELVIN = UnitDescriptor(
    'microgram per cubic metre kelvin', 'J34', """(µg/m³)/K"""
)
ALL_UNITS.append(MICROGRAM_PER_CUBIC_METRE_KELVIN)
MICROGRAM_PER_CUBIC_METRE_BAR = UnitDescriptor(
    'microgram per cubic metre bar', 'J35', """(µg/m³)/bar"""
)
...
BRITISH_THERMAL_UNIT_MEAN = UnitDescriptor(
    'British thermal unit (mean)', 'J39', """Btu"""
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_MEAN)
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_FOOT_PER_HOUR_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_INCH_PER_HOUR_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_INCH_PER_SECOND_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_POUND_DEGREE_FAHRENHEIT = (
    UnitDescriptor(
        (
            'British thermal unit (international table) per pound degree'
            ' Fahrenheit'
        ),
        'J43',
        """BtuIT/(lb·°F)""",
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_MINUTE = UnitDescriptor(
    'British thermal unit (international table) per minute',
    'J44',
    """BtuIT/min""",
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_MINUTE)
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_SECOND = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_HOUR = UnitDescriptor(
    'British thermal unit (thermochemical) per hour', 'J47', """Btuth/h"""
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_HOUR)
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_INCH_PER_HOUR_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_INCH_PER_SECOND_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_MINUTE = UnitDescriptor(
    'British thermal unit (thermochemical) per minute', 'J51', """Btuth/min"""
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_MINUTE)
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_SECOND = UnitDescriptor(
    'British thermal unit (thermochemical) per second', 'J52', """Btuth/s"""
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_SECOND)
COULOMB_SQUARE_METRE_PER_KILOGRAM = UnitDescriptor(
    'coulomb square metre per kilogram', 'J53', """C·m²/kg"""
)
...
BARREL_UK_PETROLEUM = UnitDescriptor(
    'barrel (UK petroleum)', 'J57', """bbl (UK liq.)"""
)
ALL_UNITS.append(BARREL_UK_PETROLEUM)
BARREL_UK_PETROLEUM_PER_MINUTE = UnitDescriptor(
    'barrel (UK petroleum) per minute', 'J58', """bbl (UK liq.)/min"""
)
ALL_UNITS.append(BARREL_UK_PETROLEUM_PER_MINUTE)
BARREL_UK_PETROLEUM_PER_DAY = UnitDescriptor(
    'barrel (UK petroleum) per day', 'J59', """bbl (UK liq.)/d"""
)
ALL_UNITS.append(BARREL_UK_PETROLEUM_PER_DAY)
BARREL_UK_PETROLEUM_PER_HOUR = UnitDescriptor(
    'barrel (UK petroleum) per hour', 'J60', """bbl (UK liq.)/h"""
)
ALL_UNITS.append(BARREL_UK_PETROLEUM_PER_HOUR)
BARREL_UK_PETROLEUM_PER_SECOND = UnitDescriptor(
    'barrel (UK petroleum) per second', 'J61', """bbl (UK liq.)/s"""
)
ALL_UNITS.append(BARREL_UK_PETROLEUM_PER_SECOND)
BARREL_US_PETROLEUM_PER_HOUR = UnitDescriptor(
    'barrel (US petroleum) per hour', 'J62', """bbl (US)/h"""
)
ALL_UNITS.append(BARREL_US_PETROLEUM_PER_HOUR)
BARREL_US_PETROLEUM_PER_SECOND = UnitDescriptor(
    'barrel (US petroleum) per second', 'J63', """bbl (US)/s"""
)
ALL_UNITS.append(BARREL_US_PETROLEUM_PER_SECOND)
BUSHEL_UK_PER_DAY = UnitDescriptor(
    'bushel (UK) per day', 'J64', """bu (UK)/d"""
)
ALL_UNITS.append(BUSHEL_UK_PER_DAY)
BUSHEL_UK_PER_HOUR = UnitDescriptor(
    'bushel (UK) per hour', 'J65', """bu (UK)/h"""
)
ALL_UNITS.append(BUSHEL_UK_PER_HOUR)
BUSHEL_UK_PER_MINUTE = UnitDescriptor(
    'bushel (UK) per minute', 'J66', """bu (UK)/min"""
)
ALL_UNITS.append(BUSHEL_UK_PER_MINUTE)
BUSHEL_UK_PER_SECOND = UnitDescriptor(
    'bushel (UK) per second', 'J67', """bu (UK)/s"""
)
ALL_UNITS.append(BUSHEL_UK_PER_SECOND)
BUSHEL_US_DRY_PER_DAY = UnitDescriptor(
    'bushel (US dry) per day', 'J68', """bu (US dry)/d"""
)
ALL_UNITS.append(BUSHEL_US_DRY_PER_DAY)
BUSHEL_US_DRY_PER_HOUR = UnitDescriptor(
    'bushel (US dry) per hour', 'J69', """bu (US dry)/h"""
)
ALL_UNITS.append(BUSHEL_US_DRY_PER_HOUR)
BUSHEL_US_DRY_PER_MINUTE = UnitDescriptor(
    'bushel (US dry) per minute', 'J70', """bu (US dry)/min"""
)
ALL_UNITS.append(BUSHEL_US_DRY_PER_MINUTE)
BUSHEL_US_DRY_PER_SECOND = UnitDescriptor(
    'bushel (US dry) per second', 'J71', """bu (US dry)/s"""
)
...
CENTIPOISE_PER_KELVIN = UnitDescriptor(
    'centipoise per kelvin', 'J73', """cP/K"""
)
...
CALORIE_INTERNATIONAL_TABLE_PER_GRAM_DEGREE_CELSIUS = UnitDescriptor(
    'calorie (international table) per gram degree Celsius',
    'J76',
    """calIT/(g·°C)""",
)
ALL_UNITS.append(CALORIE_INTERNATIONAL_TABLE_PER_GRAM_DEGREE_CELSIUS)
CALORIE_THERMOCHEMICAL_PER_CENTIMETRE_SECOND_DEGREE_CELSIUS = UnitDescriptor(
...
CALORIE_THERMOCHEMICAL_PER_GRAM_DEGREE_CELSIUS = UnitDescriptor(
    'calorie (thermochemical) per gram degree Celsius',
    'J79',
    """calth/(g·°C)""",
)
ALL_UNITS.append(CALORIE_THERMOCHEMICAL_PER_GRAM_DEGREE_CELSIUS)
CALORIE_THERMOCHEMICAL_PER_MINUTE = UnitDescriptor(
    'calorie (thermochemical) per minute', 'J81', """calth/min"""
)
ALL_UNITS.append(CALORIE_THERMOCHEMICAL_PER_MINUTE)
CALORIE_THERMOCHEMICAL_PER_SECOND = UnitDescriptor(
    'calorie (thermochemical) per second', 'J82', """calth/s"""
)
ALL_UNITS.append(CALORIE_THERMOCHEMICAL_PER_SECOND)
CLO = UnitDescriptor('clo', 'J83', """clo""")
ALL_UNITS.append(CLO)
CENTIMETRE_PER_SECOND_KELVIN = UnitDescriptor(
    'centimetre per second kelvin', 'J84', """(cm/s)/K"""
)
ALL_UNITS.append(CENTIMETRE_PER_SECOND_KELVIN)
CENTIMETRE_PER_SECOND_BAR = UnitDescriptor(
    'centimetre per second bar', 'J85', """(cm/s)/bar"""
)
ALL_UNITS.append(CENTIMETRE_PER_SECOND_BAR)
CUBIC_CENTIMETRE_PER_CUBIC_METRE = UnitDescriptor(
    'cubic centimetre per cubic metre', 'J87', """cm³/m³"""
)
ALL_UNITS.append(CUBIC_CENTIMETRE_PER_CUBIC_METRE)
CENTIMETRE_OF_MERCURY = UnitDescriptor(
    'centimetre of mercury', 'J89', """cm Hg"""
)
ALL_UNITS.append(CENTIMETRE_OF_MERCURY)
CUBIC_DECIMETRE_PER_DAY = UnitDescriptor(
    'cubic decimetre per day', 'J90', """dm³/d"""
)
ALL_UNITS.append(CUBIC_DECIMETRE_PER_DAY)
CUBIC_DECIMETRE_PER_CUBIC_METRE = UnitDescriptor(
    'cubic decimetre per cubic metre', 'J91', """dm³/m³"""
)
ALL_UNITS.append(CUBIC_DECIMETRE_PER_CUBIC_METRE)
CUBIC_DECIMETRE_PER_MINUTE = UnitDescriptor(
    'cubic decimetre per minute', 'J92', """dm³/min"""
)
ALL_UNITS.append(CUBIC_DECIMETRE_PER_MINUTE)
CUBIC_DECIMETRE_PER_SECOND = UnitDescriptor(
    'cubic decimetre per second', 'J93', """dm³/s"""
)
...
OUNCE_UK_FLUID_PER_DAY = UnitDescriptor(
    'ounce (UK fluid) per day', 'J95', """fl oz (UK)/d"""
)
ALL_UNITS.append(OUNCE_UK_FLUID_PER_DAY)
OUNCE_UK_FLUID_PER_HOUR = UnitDescriptor(
    'ounce (UK fluid) per hour', 'J96', """fl oz (UK)/h"""
)
ALL_UNITS.append(OUNCE_UK_FLUID_PER_HOUR)
OUNCE_UK_FLUID_PER_MINUTE = UnitDescriptor(
    'ounce (UK fluid) per minute', 'J97', """fl oz (UK)/min"""
)
ALL_UNITS.append(OUNCE_UK_FLUID_PER_MINUTE)
OUNCE_UK_FLUID_PER_SECOND = UnitDescriptor(
    'ounce (UK fluid) per second', 'J98', """fl oz (UK)/s"""
)
ALL_UNITS.append(OUNCE_UK_FLUID_PER_SECOND)
OUNCE_US_FLUID_PER_DAY = UnitDescriptor(
    'ounce (US fluid) per day', 'J99', """fl oz (US)/d"""
)
...
MEGAJOULE_PER_KILOGRAM = UnitDescriptor(
    'megajoule per kilogram', 'JK', """MJ/kg"""
)
ALL_UNITS.append(MEGAJOULE_PER_KILOGRAM)
MEGAJOULE_PER_CUBIC_METRE = UnitDescriptor(
    'megajoule per cubic metre', 'JM', """MJ/m³"""
)
...
OUNCE_US_FLUID_PER_HOUR = UnitDescriptor(
    'ounce (US fluid) per hour', 'K10', """fl oz (US)/h"""
)
ALL_UNITS.append(OUNCE_US_FLUID_PER_HOUR)
OUNCE_US_FLUID_PER_MINUTE = UnitDescriptor(
    'ounce (US fluid) per minute', 'K11', """fl oz (US)/min"""
)
ALL_UNITS.append(OUNCE_US_FLUID_PER_MINUTE)
OUNCE_US_FLUID_PER_SECOND = UnitDescriptor(
    'ounce (US fluid) per second', 'K12', """fl oz (US)/s"""
)
ALL_UNITS.append(OUNCE_US_FLUID_PER_SECOND)
FOOT_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
    'foot per degree Fahrenheit', 'K13', """ft/°F"""
)
...
FOOT_POUND_FORCE_PER_HOUR = UnitDescriptor(
    'foot pound-force per hour', 'K15', """ft·lbf/h"""
)
ALL_UNITS.append(FOOT_POUND_FORCE_PER_HOUR)
FOOT_POUND_FORCE_PER_MINUTE = UnitDescriptor(
    'foot pound-force per minute', 'K16', """ft·lbf/min"""
)
...
FOOT_PER_SECOND_DEGREE_FAHRENHEIT = UnitDescriptor(
    'foot per second degree Fahrenheit', 'K18', """(ft/s)/°F"""
)
ALL_UNITS.append(FOOT_PER_SECOND_DEGREE_FAHRENHEIT)
FOOT_PER_SECOND_PSI = UnitDescriptor(
    'foot per second psi', 'K19', """(ft/s)/psi"""
)
ALL_UNITS.append(FOOT_PER_SECOND_PSI)
KILOVOLT_AMPERE_REACTIVE_DEMAND = UnitDescriptor(
    'kilovolt ampere reactive demand', 'K2', """"""
)
ALL_UNITS.append(KILOVOLT_AMPERE_REACTIVE_DEMAND)
RECIPROCAL_CUBIC_FOOT = UnitDescriptor(
    'reciprocal cubic foot', 'K20', """1/ft³"""
)
ALL_UNITS.append(RECIPROCAL_CUBIC_FOOT)
CUBIC_FOOT_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
    'cubic foot per degree Fahrenheit', 'K21', """ft³/°F"""
)
...
GALLON_UK_PER_DAY = UnitDescriptor(
    'gallon (UK) per day', 'K26', """gal (UK)/d"""
)
ALL_UNITS.append(GALLON_UK_PER_DAY)
GALLON_UK_PER_HOUR = UnitDescriptor(
    'gallon (UK) per hour', 'K27', """gal (UK)/h"""
)
ALL_UNITS.append(GALLON_UK_PER_HOUR)
GALLON_UK_PER_SECOND = UnitDescriptor(
    'gallon (UK) per second', 'K28', """gal (UK)/s"""
)
ALL_UNITS.append(GALLON_UK_PER_SECOND)
KILOVOLT_AMPERE_REACTIVE_HOUR = UnitDescriptor(
    'kilovolt ampere reactive hour', 'K3', """kvar·h"""
)
ALL_UNITS.append(KILOVOLT_AMPERE_REACTIVE_HOUR)
GALLON_US_LIQUID_PER_SECOND = UnitDescriptor(
    'gallon (US liquid) per second', 'K30', """gal (US liq.)/s"""
)
ALL_UNITS.append(GALLON_US_LIQUID_PER_SECOND)
GRAM_FORCE_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'gram-force per square centimetre', 'K31', """gf/cm²"""
)
...
GILL_UK_PER_MINUTE = UnitDescriptor(
    'gill (UK) per minute', 'K34', """gi (UK)/min"""
)
ALL_UNITS.append(GILL_UK_PER_MINUTE)
GILL_UK_PER_SECOND = UnitDescriptor(
    'gill (UK) per second', 'K35', """gi (UK)/s"""
)
...
GILL_US_PER_MINUTE = UnitDescriptor(
    'gill (US) per minute', 'K38', """gi (US)/min"""
)
ALL_UNITS.append(GILL_US_PER_MINUTE)
GILL_US_PER_SECOND = UnitDescriptor(
    'gill (US) per second', 'K39', """gi (US)/s"""
)
ALL_UNITS.append(GILL_US_PER_SECOND)
STANDARD_ACCELERATION_OF_FREE_FALL = UnitDescriptor(
    'standard acceleration of free fall', 'K40', """gn"""
)
ALL_UNITS.append(STANDARD_ACCELERATION_OF_FREE_FALL)
GRAIN_PER_GALLON_US = UnitDescriptor(
    'grain per gallon (US)', 'K41', """gr/gal (US)"""
)
ALL_UNITS.append(GRAIN_PER_GALLON_US)
HORSEPOWER_BOILER = UnitDescriptor(
    'horsepower (boiler)', 'K42', """boiler hp"""
)
ALL_UNITS.append(HORSEPOWER_BOILER)
HORSEPOWER_ELECTRIC = UnitDescriptor(
    'horsepower (electric)', 'K43', """electric hp"""
)
ALL_UNITS.append(HORSEPOWER_ELECTRIC)
INCH_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
    'inch per degree Fahrenheit', 'K45', """in/°F"""
)
...
INCH_PER_SECOND_DEGREE_FAHRENHEIT = UnitDescriptor(
    'inch per second degree Fahrenheit', 'K47', """(in/s)/°F"""
)
ALL_UNITS.append(INCH_PER_SECOND_DEGREE_FAHRENHEIT)
INCH_PER_SECOND_PSI = UnitDescriptor(
    'inch per second psi', 'K48', """(in/s)/psi"""
)
ALL_UNITS.append(INCH_PER_SECOND_PSI)
RECIPROCAL_CUBIC_INCH = UnitDescriptor(
    'reciprocal cubic inch', 'K49', """1/in³"""
)
ALL_UNITS.append(RECIPROCAL_CUBIC_INCH)
KILOVOLT_AMPERE_REACTIVE = UnitDescriptor(
    'kilovolt ampere (reactive)', 'K5', """kvar"""
)
...
KILOCALORIE_INTERNATIONAL_TABLE_PER_HOUR_METRE_DEGREE_CELSIUS = UnitDescriptor(
...
KILOCALORIE_THERMOCHEMICAL = UnitDescriptor(
    'kilocalorie (thermochemical)', 'K53', """kcalth"""
)
ALL_UNITS.append(KILOCALORIE_THERMOCHEMICAL)
KILOCALORIE_THERMOCHEMICAL_PER_MINUTE = UnitDescriptor(
    'kilocalorie (thermochemical) per minute', 'K54', """kcalth/min"""
)
ALL_UNITS.append(KILOCALORIE_THERMOCHEMICAL_PER_MINUTE)
KILOCALORIE_THERMOCHEMICAL_PER_SECOND = UnitDescriptor(
    'kilocalorie (thermochemical) per second', 'K55', """kcalth/s"""
)
...
KILOMOLE_PER_CUBIC_METRE_KELVIN = UnitDescriptor(
    'kilomole per cubic metre kelvin', 'K59', """(kmol/m³)/K"""
)
ALL_UNITS.append(KILOMOLE_PER_CUBIC_METRE_KELVIN)
KILOLITRE = UnitDescriptor('kilolitre', 'K6', """kl""")
ALL_UNITS.append(KILOLITRE)
KILOMOLE_PER_CUBIC_METRE_BAR = UnitDescriptor(
    'kilomole per cubic metre bar', 'K60', """(kmol/m³)/bar"""
)
ALL_UNITS.append(KILOMOLE_PER_CUBIC_METRE_BAR)
KILOMOLE_PER_MINUTE = UnitDescriptor(
    'kilomole per minute', 'K61', """kmol/min"""
)
...
POUND_AVOIRDUPOIS_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
    'pound (avoirdupois) per degree Fahrenheit', 'K64', """lb/°F"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_DEGREE_FAHRENHEIT)
POUND_AVOIRDUPOIS_SQUARE_FOOT = UnitDescriptor(
    'pound (avoirdupois) square foot', 'K65', """lb·ft²"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_SQUARE_FOOT)
POUND_AVOIRDUPOIS_PER_DAY = UnitDescriptor(
    'pound (avoirdupois) per day', 'K66', """lb/d"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_DAY)
POUND_PER_FOOT_HOUR = UnitDescriptor(
    'pound per foot hour', 'K67', """lb/(ft·h)"""
)
ALL_UNITS.append(POUND_PER_FOOT_HOUR)
POUND_PER_FOOT_SECOND = UnitDescriptor(
    'pound per foot second', 'K68', """lb/(ft·s)"""
)
ALL_UNITS.append(POUND_PER_FOOT_SECOND)
POUND_AVOIRDUPOIS_PER_CUBIC_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    'pound (avoirdupois) per cubic foot degree Fahrenheit',
    'K69',
    """(lb/ft³)/°F""",
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_CUBIC_FOOT_DEGREE_FAHRENHEIT)
POUND_AVOIRDUPOIS_PER_CUBIC_FOOT_PSI = UnitDescriptor(
    'pound (avoirdupois) per cubic foot psi', 'K70', """(lb/ft³)/psi"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_CUBIC_FOOT_PSI)
POUND_AVOIRDUPOIS_PER_GALLON_UK = UnitDescriptor(
    'pound (avoirdupois) per gallon (UK)', 'K71', """lb/gal (UK)"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_GALLON_UK)
POUND_AVOIRDUPOIS_PER_HOUR_DEGREE_FAHRENHEIT = UnitDescriptor(
    'pound (avoirdupois) per hour degree Fahrenheit', 'K73', """(lb/h)/°F"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_HOUR_DEGREE_FAHRENHEIT)
POUND_AVOIRDUPOIS_PER_HOUR_PSI = UnitDescriptor(
    'pound (avoirdupois) per hour psi', 'K74', """(lb/h)/psi"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_HOUR_PSI)
POUND_AVOIRDUPOIS_PER_CUBIC_INCH_DEGREE_FAHRENHEIT = UnitDescriptor(
    'pound (avoirdupois) per cubic inch degree Fahrenheit',
    'K75',
    """(lb/in³)/°F""",
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_CUBIC_INCH_DEGREE_FAHRENHEIT)
POUND_AVOIRDUPOIS_PER_CUBIC_INCH_PSI = UnitDescriptor(
    'pound (avoirdupois) per cubic inch psi', 'K76', """(lb/in³)/psi"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_CUBIC_INCH_PSI)
POUND_AVOIRDUPOIS_PER_PSI = UnitDescriptor(
    'pound (avoirdupois) per psi', 'K77', """lb/psi"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_PSI)
POUND_AVOIRDUPOIS_PER_MINUTE = UnitDescriptor(
    'pound (avoirdupois) per minute', 'K78', """lb/min"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_MINUTE)
POUND_AVOIRDUPOIS_PER_MINUTE_DEGREE_FAHRENHEIT = UnitDescriptor(
    'pound (avoirdupois) per minute degree Fahrenheit', 'K79', """lb/(min·°F)"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_MINUTE_DEGREE_FAHRENHEIT)
POUND_AVOIRDUPOIS_PER_MINUTE_PSI = UnitDescriptor(
    'pound (avoirdupois) per minute psi', 'K80', """(lb/min)/psi"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_MINUTE_PSI)
POUND_AVOIRDUPOIS_PER_SECOND = UnitDescriptor(
    'pound (avoirdupois) per second', 'K81', """lb/s"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_SECOND)
POUND_AVOIRDUPOIS_PER_SECOND_DEGREE_FAHRENHEIT = UnitDescriptor(
    'pound (avoirdupois) per second degree Fahrenheit', 'K82', """(lb/s)/°F"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_SECOND_DEGREE_FAHRENHEIT)
POUND_AVOIRDUPOIS_PER_SECOND_PSI = UnitDescriptor(
    'pound (avoirdupois) per second psi', 'K83', """(lb/s)/psi"""
)
ALL_UNITS.append(POUND_AVOIRDUPOIS_PER_SECOND_PSI)
POUND_PER_CUBIC_YARD = UnitDescriptor(
    'pound per cubic yard', 'K84', """lb/yd³"""
)
ALL_UNITS.append(POUND_PER_CUBIC_YARD)
POUND_FORCE_PER_SQUARE_FOOT = UnitDescriptor(
    'pound-force per square foot', 'K85', """lbf/ft²"""
)
ALL_UNITS.append(POUND_FORCE_PER_SQUARE_FOOT)
POUND_FORCE_PER_SQUARE_INCH_DEGREE_FAHRENHEIT = UnitDescriptor(
    'pound-force per square inch degree Fahrenheit', 'K86', """psi/°F"""
)
ALL_UNITS.append(POUND_FORCE_PER_SQUARE_INCH_DEGREE_FAHRENHEIT)
PSI_CUBIC_INCH_PER_SECOND = UnitDescriptor(
    'psi cubic inch per second', 'K87', """psi·in³/s"""
)
ALL_UNITS.append(PSI_CUBIC_INCH_PER_SECOND)
PSI_LITRE_PER_SECOND = UnitDescriptor(
    'psi litre per second', 'K88', """psi·l/s"""
)
ALL_UNITS.append(PSI_LITRE_PER_SECOND)
PSI_CUBIC_METRE_PER_SECOND = UnitDescriptor(
    'psi cubic metre per second', 'K89', """psi·m³/s"""
)
ALL_UNITS.append(PSI_CUBIC_METRE_PER_SECOND)
PSI_CUBIC_YARD_PER_SECOND = UnitDescriptor(
    'psi cubic yard per second', 'K90', """psi·yd³/s"""
)
ALL_UNITS.append(PSI_CUBIC_YARD_PER_SECOND)
POUND_FORCE_SECOND_PER_SQUARE_FOOT = UnitDescriptor(
    'pound-force second per square foot', 'K91', """lbf·s/ft²"""
)
ALL_UNITS.append(POUND_FORCE_SECOND_PER_SQUARE_FOOT)
POUND_FORCE_SECOND_PER_SQUARE_INCH = UnitDescriptor(
    'pound-force second per square inch', 'K92', """lbf·s/in²"""
)
...
QUART_UK_LIQUID_PER_DAY = UnitDescriptor(
    'quart (UK liquid) per day', 'K94', """qt (UK liq.)/d"""
)
ALL_UNITS.append(QUART_UK_LIQUID_PER_DAY)
QUART_UK_LIQUID_PER_HOUR = UnitDescriptor(
    'quart (UK liquid) per hour', 'K95', """qt (UK liq.)/h"""
)
ALL_UNITS.append(QUART_UK_LIQUID_PER_HOUR)
QUART_UK_LIQUID_PER_MINUTE = UnitDescriptor(
    'quart (UK liquid) per minute', 'K96', """qt (UK liq.)/min"""
)
ALL_UNITS.append(QUART_UK_LIQUID_PER_MINUTE)
QUART_UK_LIQUID_PER_SECOND = UnitDescriptor(
    'quart (UK liquid) per second', 'K97', """qt (UK liq.)/s"""
)
ALL_UNITS.append(QUART_UK_LIQUID_PER_SECOND)
QUART_US_LIQUID_PER_DAY = UnitDescriptor(
    'quart (US liquid) per day', 'K98', """qt (US liq.)/d"""
)
ALL_UNITS.append(QUART_US_LIQUID_PER_DAY)
QUART_US_LIQUID_PER_HOUR = UnitDescriptor(
    'quart (US liquid) per hour', 'K99', """qt (US liq.)/h"""
)
...
KILOGRAM_OF_CHOLINE_CHLORIDE = UnitDescriptor(
    'kilogram of choline chloride', 'KCC', """kg C₅ H₁₄ClNO"""
)
...
KILOGRAM_DRAINED_NET_WEIGHT = UnitDescriptor(
    'kilogram drained net weight', 'KDW', """kg/net eda"""
)
...
LACTIC_DRY_MATERIAL_PERCENTAGE = UnitDescriptor(
...
KILOGRAM_OF_METHYLAMINE = UnitDescriptor(
    'kilogram of methylamine', 'KMA', """kg met.am."""
)
...
KILOGRAM_PER_CUBIC_METRE = UnitDescriptor(
    'kilogram per cubic metre', 'KMQ', """kg/m³"""
)
...
KILONEWTON_PER_SQUARE_METRE = UnitDescriptor(
    'kilonewton per square metre', 'KNM', """kN/m2"""
)
ALL_UNITS.append(KILONEWTON_PER_SQUARE_METRE)
KILOGRAM_NAMED_SUBSTANCE = UnitDescriptor(
...
MILLIEQUIVALENCE_CAUSTIC_POTASH_PER_GRAM_OF_PRODUCT = UnitDescriptor(
...
KILOGRAM_OF_POTASSIUM_HYDROXIDE_CAUSTIC_POTASH = UnitDescriptor(
    'kilogram of potassium hydroxide (caustic potash)', 'KPH', """kg KOH"""
)
ALL_UNITS.append(KILOGRAM_OF_POTASSIUM_HYDROXIDE_CAUSTIC_POTASH)
KILOGRAM_OF_POTASSIUM_OXIDE = UnitDescriptor(
    'kilogram of potassium oxide', 'KPO', """kg K₂O"""
)
ALL_UNITS.append(KILOGRAM_OF_POTASSIUM_OXIDE)
KILOGRAM_OF_PHOSPHORUS_PENTOXIDE_PHOSPHORIC_ANHYDRIDE = UnitDescriptor(
...
THOUSAND_POUND_PER_SQUARE_INCH = UnitDescriptor(
    'thousand pound per square inch', 'KS', """"""
)
ALL_UNITS.append(THOUSAND_POUND_PER_SQUARE_INCH)
KILOGRAM_OF_SUBSTANCE_90_PERCENT_DRY = UnitDescriptor(
    'kilogram of substance 90 % dry', 'KSD', """kg 90 % sdt"""
)
ALL_UNITS.append(KILOGRAM_OF_SUBSTANCE_90_PERCENT_DRY)
KILOGRAM_OF_SODIUM_HYDROXIDE_CAUSTIC_SODA = UnitDescriptor(
    'kilogram of sodium hydroxide (caustic soda)', 'KSH', """kg NaOH"""
)
...
KILOGRAM_PER_MILLIMETRE = UnitDescriptor(
    'kilogram per millimetre', 'KW', """kg/mm"""
)
...
KILOWATT_HOUR_PER_NORMALIZED_CUBIC_METRE = UnitDescriptor(
    'Kilowatt hour per normalized cubic metre', 'KWN', """"""
)
ALL_UNITS.append(KILOWATT_HOUR_PER_NORMALIZED_CUBIC_METRE)
KILOGRAM_OF_TUNGSTEN_TRIOXIDE = UnitDescriptor(
    'kilogram of tungsten trioxide', 'KWO', """kg WO₃"""
)
ALL_UNITS.append(KILOGRAM_OF_TUNGSTEN_TRIOXIDE)
KILOWATT_HOUR_PER_STANDARD_CUBIC_METRE = UnitDescriptor(
...
MILLILITRE_PER_KILOGRAM = UnitDescriptor(
    'millilitre per kilogram', 'KX', """ml/kg"""
)
ALL_UNITS.append(MILLILITRE_PER_KILOGRAM)
QUART_US_LIQUID_PER_MINUTE = UnitDescriptor(
    'quart (US liquid) per minute', 'L10', """qt (US liq.)/min"""
)
ALL_UNITS.append(QUART_US_LIQUID_PER_MINUTE)
QUART_US_LIQUID_PER_SECOND = UnitDescriptor(
    'quart (US liquid) per second', 'L11', """qt (US liq.)/s"""
)
ALL_UNITS.append(QUART_US_LIQUID_PER_SECOND)
METRE_PER_SECOND_KELVIN = UnitDescriptor(
    'metre per second kelvin', 'L12', """(m/s)/K"""
)
ALL_UNITS.append(METRE_PER_SECOND_KELVIN)
METRE_PER_SECOND_BAR = UnitDescriptor(
    'metre per second bar', 'L13', """(m/s)/bar"""
)
ALL_UNITS.append(METRE_PER_SECOND_BAR)
SQUARE_METRE_HOUR_DEGREE_CELSIUS_PER_KILOCALORIE_INTERNATIONAL_TABLE = (
    UnitDescriptor(
        (
            'square metre hour degree Celsius per kilocalorie (international'
            ' table)'
        ),
        'L14',
        """m²·h·°C/kcal""",
...
MILLIPASCAL_SECOND_PER_KELVIN = UnitDescriptor(
    'millipascal second per kelvin', 'L15', """mPa·s/K"""
)
ALL_UNITS.append(MILLIPASCAL_SECOND_PER_KELVIN)
MILLIPASCAL_SECOND_PER_BAR = UnitDescriptor(
    'millipascal second per bar', 'L16', """mPa·s/bar"""
)
ALL_UNITS.append(MILLIPASCAL_SECOND_PER_BAR)
MILLIGRAM_PER_CUBIC_METRE_KELVIN = UnitDescriptor(
    'milligram per cubic metre kelvin', 'L17', """(mg/m³)/K"""
)
ALL_UNITS.append(MILLIGRAM_PER_CUBIC_METRE_KELVIN)
MILLIGRAM_PER_CUBIC_METRE_BAR = UnitDescriptor(
    'milligram per cubic metre bar', 'L18', """(mg/m³)/bar"""
)
...
RECIPROCAL_CUBIC_MILLIMETRE = UnitDescriptor(
    'reciprocal cubic millimetre', 'L20', """1/mm³"""
)
ALL_UNITS.append(RECIPROCAL_CUBIC_MILLIMETRE)
CUBIC_MILLIMETRE_PER_CUBIC_METRE = UnitDescriptor(
    'cubic millimetre per cubic metre', 'L21', """mm³/m³"""
)
...
MOLE_PER_KILOGRAM_KELVIN = UnitDescriptor(
    'mole per kilogram kelvin', 'L24', """(mol/kg)/K"""
)
ALL_UNITS.append(MOLE_PER_KILOGRAM_KELVIN)
MOLE_PER_KILOGRAM_BAR = UnitDescriptor(
    'mole per kilogram bar', 'L25', """(mol/kg)/bar"""
)
ALL_UNITS.append(MOLE_PER_KILOGRAM_BAR)
MOLE_PER_LITRE_KELVIN = UnitDescriptor(
    'mole per litre kelvin', 'L26', """(mol/l)/K"""
)
ALL_UNITS.append(MOLE_PER_LITRE_KELVIN)
MOLE_PER_LITRE_BAR = UnitDescriptor(
    'mole per litre bar', 'L27', """(mol/l)/bar"""
)
ALL_UNITS.append(MOLE_PER_LITRE_BAR)
MOLE_PER_CUBIC_METRE_KELVIN = UnitDescriptor(
    'mole per cubic metre kelvin', 'L28', """(mol/m³)/K"""
)
ALL_UNITS.append(MOLE_PER_CUBIC_METRE_KELVIN)
MOLE_PER_CUBIC_METRE_BAR = UnitDescriptor(
    'mole per cubic metre bar', 'L29', """(mol/m³)/bar"""
)
...
MILLIROENTGEN_AEQUIVALENT_MEN = UnitDescriptor(
    'milliroentgen aequivalent men', 'L31', """mrem"""
)
ALL_UNITS.append(MILLIROENTGEN_AEQUIVALENT_MEN)
NANOGRAM_PER_KILOGRAM = UnitDescriptor(
    'nanogram per kilogram', 'L32', """ng/kg"""
)
ALL_UNITS.append(NANOGRAM_PER_KILOGRAM)
OUNCE_AVOIRDUPOIS_PER_DAY = UnitDescriptor(
    'ounce (avoirdupois) per day', 'L33', """oz/d"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_DAY)
OUNCE_AVOIRDUPOIS_PER_HOUR = UnitDescriptor(
    'ounce (avoirdupois) per hour', 'L34', """oz/h"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_HOUR)
OUNCE_AVOIRDUPOIS_PER_MINUTE = UnitDescriptor(
    'ounce (avoirdupois) per minute', 'L35', """oz/min"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_MINUTE)
OUNCE_AVOIRDUPOIS_PER_SECOND = UnitDescriptor(
    'ounce (avoirdupois) per second', 'L36', """oz/s"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_SECOND)
OUNCE_AVOIRDUPOIS_PER_GALLON_UK = UnitDescriptor(
    'ounce (avoirdupois) per gallon (UK)', 'L37', """oz/gal (UK)"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_GALLON_UK)
OUNCE_AVOIRDUPOIS_PER_GALLON_US = UnitDescriptor(
    'ounce (avoirdupois) per gallon (US)', 'L38', """oz/gal (US)"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_GALLON_US)
OUNCE_AVOIRDUPOIS_PER_CUBIC_INCH = UnitDescriptor(
    'ounce (avoirdupois) per cubic inch', 'L39', """oz/in³"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_CUBIC_INCH)
OUNCE_AVOIRDUPOIS_FORCE = UnitDescriptor(
    'ounce (avoirdupois)-force', 'L40', """ozf"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_FORCE)
OUNCE_AVOIRDUPOIS_FORCE_INCH = UnitDescriptor(
    'ounce (avoirdupois)-force inch', 'L41', """ozf·in"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_FORCE_INCH)
PICOSIEMENS_PER_METRE = UnitDescriptor(
    'picosiemens per metre', 'L42', """pS/m"""
)
...
PECK_UK_PER_MINUTE = UnitDescriptor(
    'peck (UK) per minute', 'L46', """pk (UK)/min"""
)
ALL_UNITS.append(PECK_UK_PER_MINUTE)
PECK_UK_PER_SECOND = UnitDescriptor(
    'peck (UK) per second', 'L47', """pk (UK)/s"""
)
ALL_UNITS.append(PECK_UK_PER_SECOND)
PECK_US_DRY_PER_DAY = UnitDescriptor(
    'peck (US dry) per day', 'L48', """pk (US dry)/d"""
)
ALL_UNITS.append(PECK_US_DRY_PER_DAY)
PECK_US_DRY_PER_HOUR = UnitDescriptor(
    'peck (US dry) per hour', 'L49', """pk (US dry)/h"""
)
ALL_UNITS.append(PECK_US_DRY_PER_HOUR)
PECK_US_DRY_PER_MINUTE = UnitDescriptor(
    'peck (US dry) per minute', 'L50', """pk (US dry)/min"""
)
ALL_UNITS.append(PECK_US_DRY_PER_MINUTE)
PECK_US_DRY_PER_SECOND = UnitDescriptor(
    'peck (US dry) per second', 'L51', """pk (US dry)/s"""
)
...
PINT_UK_PER_MINUTE = UnitDescriptor(
    'pint (UK) per minute', 'L55', """pt (UK)/min"""
)
ALL_UNITS.append(PINT_UK_PER_MINUTE)
PINT_UK_PER_SECOND = UnitDescriptor(
    'pint (UK) per second', 'L56', """pt (UK)/s"""
)
ALL_UNITS.append(PINT_UK_PER_SECOND)
PINT_US_LIQUID_PER_DAY = UnitDescriptor(
    'pint (US liquid) per day', 'L57', """pt (US liq.)/d"""
)
ALL_UNITS.append(PINT_US_LIQUID_PER_DAY)
PINT_US_LIQUID_PER_HOUR = UnitDescriptor(
    'pint (US liquid) per hour', 'L58', """pt (US liq.)/h"""
)
ALL_UNITS.append(PINT_US_LIQUID_PER_HOUR)
PINT_US_LIQUID_PER_MINUTE = UnitDescriptor(
    'pint (US liquid) per minute', 'L59', """pt (US liq.)/min"""
)
ALL_UNITS.append(PINT_US_LIQUID_PER_MINUTE)
PINT_US_LIQUID_PER_SECOND = UnitDescriptor(
    'pint (US liquid) per second', 'L60', """pt (US liq.)/s"""
)
...
SLUG_PER_FOOT_SECOND = UnitDescriptor(
    'slug per foot second', 'L64', """slug/(ft·s)"""
)
ALL_UNITS.append(SLUG_PER_FOOT_SECOND)
SLUG_PER_CUBIC_FOOT = UnitDescriptor(
    'slug per cubic foot', 'L65', """slug/ft³"""
)
...
TONNE_PER_DAY_KELVIN = UnitDescriptor(
    'tonne per day kelvin', 'L72', """(t/d)/K"""
)
...
TONNE_PER_HOUR_KELVIN = UnitDescriptor(
    'tonne per hour kelvin', 'L74', """(t/h)/K"""
)
ALL_UNITS.append(TONNE_PER_HOUR_KELVIN)
TONNE_PER_HOUR_BAR = UnitDescriptor(
    'tonne per hour bar', 'L75', """(t/h)/bar"""
)
ALL_UNITS.append(TONNE_PER_HOUR_BAR)
TONNE_PER_CUBIC_METRE_KELVIN = UnitDescriptor(
    'tonne per cubic metre kelvin', 'L76', """(t/m³)/K"""
)
ALL_UNITS.append(TONNE_PER_CUBIC_METRE_KELVIN)
TONNE_PER_CUBIC_METRE_BAR = UnitDescriptor(
    'tonne per cubic metre bar', 'L77', """(t/m³)/bar"""
)
...
TONNE_PER_MINUTE_KELVIN = UnitDescriptor(
    'tonne per minute kelvin', 'L79', """(t/min)/K"""
)
ALL_UNITS.append(TONNE_PER_MINUTE_KELVIN)
TONNE_PER_MINUTE_BAR = UnitDescriptor(
    'tonne per minute bar', 'L80', """(t/min)/bar"""
)
...
TONNE_PER_SECOND_KELVIN = UnitDescriptor(
    'tonne per second kelvin', 'L82', """(t/s)/K"""
)
ALL_UNITS.append(TONNE_PER_SECOND_KELVIN)
TONNE_PER_SECOND_BAR = UnitDescriptor(
    'tonne per second bar', 'L83', """(t/s)/bar"""
)
ALL_UNITS.append(TONNE_PER_SECOND_BAR)
TON_UK_SHIPPING = UnitDescriptor(
    'ton (UK shipping)', 'L84', """British shipping ton"""
)
...
TON_US_SHIPPING = UnitDescriptor(
    'ton (US shipping)', 'L86', """(US) shipping ton"""
)
ALL_UNITS.append(TON_US_SHIPPING)
TON_SHORT_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
    'ton short per degree Fahrenheit', 'L87', """ton (US)/°F"""
)
...
TON_SHORT_PER_HOUR_DEGREE_FAHRENHEIT = UnitDescriptor(
    'ton short per hour degree Fahrenheit', 'L89', """ton (US)/(h·°F)"""
)
ALL_UNITS.append(TON_SHORT_PER_HOUR_DEGREE_FAHRENHEIT)
TON_SHORT_PER_HOUR_PSI = UnitDescriptor(
    'ton short per hour psi', 'L90', """(ton (US)/h)/psi"""
)
ALL_UNITS.append(TON_SHORT_PER_HOUR_PSI)
TON_SHORT_PER_PSI = UnitDescriptor(
    'ton short per psi', 'L91', """ton (US)/psi"""
)
ALL_UNITS.append(TON_SHORT_PER_PSI)
TON_UK_LONG_PER_CUBIC_YARD = UnitDescriptor(
    'ton (UK long) per cubic yard', 'L92', """ton.l/yd³ (UK)"""
)
ALL_UNITS.append(TON_UK_LONG_PER_CUBIC_YARD)
TON_US_SHORT_PER_CUBIC_YARD = UnitDescriptor(
    'ton (US short) per cubic yard', 'L93', """ton.s/yd³ (US)"""
)
ALL_UNITS.append(TON_US_SHORT_PER_CUBIC_YARD)
TON_FORCE_US_SHORT = UnitDescriptor(
    'ton-force (US short)', 'L94', """ton.sh-force"""
)
...
YARD_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
    'yard per degree Fahrenheit', 'L98', """yd/°F"""
)
...
POUND_PER_CUBIC_INCH = UnitDescriptor(
    'pound per cubic inch', 'LA', """lb/in³"""
)
ALL_UNITS.append(POUND_PER_CUBIC_INCH)
LACTOSE_EXCESS_PERCENTAGE = UnitDescriptor(
...
LOT_UNIT_OF_PROCUREMENT = UnitDescriptor(
...
TON_UK_OR_LONG_TON_US = UnitDescriptor(
    'ton (UK) or long ton (US)', 'LTN', """ton (UK)"""
)
ALL_UNITS.append(TON_UK_OR_LONG_TON_US)
LITRE = UnitDescriptor('litre', 'LTR', """l""")
ALL_UNITS.append(LITRE)
METRIC_TON_LUBRICATING_OIL = UnitDescriptor(
...
RECIPROCAL_CUBIC_YARD = UnitDescriptor(
    'reciprocal cubic yard', 'M10', """1/yd³"""
)
ALL_UNITS.append(RECIPROCAL_CUBIC_YARD)
CUBIC_YARD_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
    'cubic yard per degree Fahrenheit', 'M11', """yd³/°F"""
)
...
CUBIC_YARD_PER_MINUTE = UnitDescriptor(
    'cubic yard per minute', 'M15', """yd³/min"""
)
ALL_UNITS.append(CUBIC_YARD_PER_MINUTE)
CUBIC_YARD_PER_SECOND = UnitDescriptor(
    'cubic yard per second', 'M16', """yd³/s"""
)
...
RECIPROCAL_MEGAKELVIN_OR_MEGAKELVIN_TO_THE_POWER_MINUS_ONE = UnitDescriptor(
...
RECIPROCAL_KILOVOLT_AMPERE_RECIPROCAL_HOUR = UnitDescriptor(
    'reciprocal kilovolt - ampere reciprocal hour', 'M21', """1/kVAh"""
)
ALL_UNITS.append(RECIPROCAL_KILOVOLT_AMPERE_RECIPROCAL_HOUR)
MILLILITRE_PER_SQUARE_CENTIMETRE_MINUTE = UnitDescriptor(
    'millilitre per square centimetre minute', 'M22', """(ml/min)/cm²"""
)
ALL_UNITS.append(MILLILITRE_PER_SQUARE_CENTIMETRE_MINUTE)
NEWTON_PER_CENTIMETRE = UnitDescriptor(
    'newton per centimetre', 'M23', """N/cm"""
)
ALL_UNITS.append(NEWTON_PER_CENTIMETRE)
OHM_KILOMETRE = UnitDescriptor('ohm kilometre', 'M24', """Ω·km""")
ALL_UNITS.append(OHM_KILOMETRE)
PERCENT_PER_DEGREE_CELSIUS = UnitDescriptor(
    'percent per degree Celsius', 'M25', """%/°C"""
)
...
KILOGRAM_PER_KILOGRAM = UnitDescriptor(
    'kilogram per kilogram', 'M29', """kg/kg"""
)
ALL_UNITS.append(KILOGRAM_PER_KILOGRAM)
RECIPROCAL_VOLT_AMPERE_RECIPROCAL_SECOND = UnitDescriptor(
    'reciprocal volt - ampere reciprocal second', 'M30', """1/(V·A·s)"""
)
ALL_UNITS.append(RECIPROCAL_VOLT_AMPERE_RECIPROCAL_SECOND)
KILOGRAM_PER_KILOMETRE = UnitDescriptor(
    'kilogram per kilometre', 'M31', """kg/km"""
)
ALL_UNITS.append(KILOGRAM_PER_KILOMETRE)
PASCAL_SECOND_PER_LITRE = UnitDescriptor(
    'pascal second per litre', 'M32', """Pa·s/l"""
)
...
NEWTON_METRE_PER_SQUARE_METRE = UnitDescriptor(
    'newton metre per square metre', 'M34', """N·m/m²"""
)
...
KILOMETRE_PER_SECOND_SQUARED = UnitDescriptor(
    'kilometre per second squared', 'M38', """km/s²"""
)
ALL_UNITS.append(KILOMETRE_PER_SECOND_SQUARED)
CENTIMETRE_PER_SECOND_SQUARED = UnitDescriptor(
    'centimetre per second squared', 'M39', """cm/s²"""
)
...
YARD_PER_SECOND_SQUARED = UnitDescriptor(
    'yard per second squared', 'M40', """yd/s²"""
)
ALL_UNITS.append(YARD_PER_SECOND_SQUARED)
MILLIMETRE_PER_SECOND_SQUARED = UnitDescriptor(
    'millimetre per second squared', 'M41', """mm/s²"""
)
ALL_UNITS.append(MILLIMETRE_PER_SECOND_SQUARED)
MILE_STATUTE_MILE_PER_SECOND_SQUARED = UnitDescriptor(
    'mile (statute mile) per second squared', 'M42', """mi/s²"""
)
...
DEGREE_UNIT_OF_ANGLE_PER_SECOND_SQUARED = UnitDescriptor(
    'degree [unit of angle] per second squared', 'M45', """°/s²"""
)
ALL_UNITS.append(DEGREE_UNIT_OF_ANGLE_PER_SECOND_SQUARED)
REVOLUTION_PER_MINUTE = UnitDescriptor(
    'revolution per minute', 'M46', """r/min"""
)
ALL_UNITS.append(REVOLUTION_PER_MINUTE)
CIRCULAR_MIL = UnitDescriptor('circular mil', 'M47', """cmil""")
ALL_UNITS.append(CIRCULAR_MIL)
SQUARE_MILE_BASED_ON_U_S_SURVEY_FOOT = UnitDescriptor(
    'square mile (based on U.S. survey foot)', 'M48', """mi² (US survey)"""
)
ALL_UNITS.append(SQUARE_MILE_BASED_ON_U_S_SURVEY_FOOT)
CHAIN_BASED_ON_U_S_SURVEY_FOOT = UnitDescriptor(
    'chain (based on U.S. survey foot)', 'M49', """ch (US survey) """
)
...
FOOT_U_S_SURVEY = UnitDescriptor(
    'foot (U.S. survey)', 'M51', """ft (US survey) """
)
ALL_UNITS.append(FOOT_U_S_SURVEY)
MILE_BASED_ON_U_S_SURVEY_FOOT = UnitDescriptor(
    'mile (based on U.S. survey foot)', 'M52', """mi (US survey) """
)
...
METRE_PER_SECOND_PASCAL = UnitDescriptor(
    'metre per second pascal', 'M59', """(m/s)/Pa"""
)
...
ACRE_FOOT_BASED_ON_U_S_SURVEY_FOOT = UnitDescriptor(
    'acre-foot (based on U.S. survey foot)', 'M67', """acre-ft (US survey)"""
)
...
CUBIC_MILE_UK_STATUTE = UnitDescriptor(
    'cubic mile (UK statute)', 'M69', """mi³"""
)
...
CUBIC_METRE_PER_PASCAL = UnitDescriptor(
    'cubic metre per pascal', 'M71', """m³/Pa"""
)
ALL_UNITS.append(CUBIC_METRE_PER_PASCAL)
BEL = UnitDescriptor('bel', 'M72', """B""")
ALL_UNITS.append(BEL)
KILOGRAM_PER_CUBIC_METRE_PASCAL = UnitDescriptor(
    'kilogram per cubic metre pascal', 'M73', """(kg/m³)/Pa"""
)
...
KILOGRAM_METRE_PER_SECOND_SQUARED = UnitDescriptor(
    'kilogram metre per second squared', 'M77', """kg·m/s²"""
)
ALL_UNITS.append(KILOGRAM_METRE_PER_SECOND_SQUARED)
POND = UnitDescriptor('pond', 'M78', """p""")
ALL_UNITS.append(POND)
SQUARE_FOOT_PER_HOUR = UnitDescriptor(
    'square foot per hour', 'M79', """ft²/h"""
)
...
SQUARE_CENTIMETRE_PER_SECOND = UnitDescriptor(
    'square centimetre per second', 'M81', """cm²/s"""
)
ALL_UNITS.append(SQUARE_CENTIMETRE_PER_SECOND)
SQUARE_METRE_PER_SECOND_PASCAL = UnitDescriptor(
    'square metre per second pascal', 'M82', """(m²/s)/Pa"""
)
...
KILOGRAM_PER_SECOND_PASCAL = UnitDescriptor(
    'kilogram per second pascal', 'M87', """(kg/s)/Pa"""
)
...
MILLION_BTU_PER_1000_CUBIC_FOOT = UnitDescriptor(
    'million Btu per 1000 cubic foot', 'M9', """MBTU/kft³"""
)
...
NEWTON_METRE_PER_RADIAN = UnitDescriptor(
    'newton metre per radian', 'M93', """N·m/rad"""
)
...
KILOGRAM_CENTIMETRE_PER_SECOND = UnitDescriptor(
    'kilogram centimetre per second', 'M98', """kg·(cm/s)"""
)
ALL_UNITS.append(KILOGRAM_CENTIMETRE_PER_SECOND)
GRAM_CENTIMETRE_PER_SECOND = UnitDescriptor(
    'gram centimetre per second', 'M99', """g·(cm/s)"""
)
...
MEGAVOLT_AMPERE_REACTIVE_HOUR = UnitDescriptor(
    'megavolt ampere reactive hour', 'MAH', """Mvar·h"""
)
...
THOUSAND_STANDARD_BRICK_EQUIVALENT = UnitDescriptor(
...
MILLIGRAM_PER_SQUARE_FOOT_PER_SIDE = UnitDescriptor(
...
SQUARE_MILE_STATUTE_MILE = UnitDescriptor(
    'square mile (statute mile)', 'MIK', """mi²"""
)
...
MILLION_INTERNATIONAL_UNIT = UnitDescriptor(
    'million international unit', 'MIU', """"""
)
ALL_UNITS.append(MILLION_INTERNATIONAL_UNIT)
MILLIGRAM_PER_SQUARE_INCH = UnitDescriptor(
    'milligram per square inch', 'MK', """mg/in²"""
)
...
CUBIC_METRE_PER_SECOND = UnitDescriptor(
    'cubic metre per second', 'MQS', """m³/s"""
)
ALL_UNITS.append(CUBIC_METRE_PER_SECOND)
METRE_PER_SECOND_SQUARED = UnitDescriptor(
    'metre per second squared', 'MSK', """m/s²"""
)
...
MEGAWATT_HOUR_1000_KW_H = UnitDescriptor(
    'megawatt hour (1000 kW.h)', 'MWH', """MW·h"""
)
ALL_UNITS.append(MEGAWATT_HOUR_1000_KW_H)
PEN_CALORIE = UnitDescriptor('pen calorie', 'N1', """""")
ALL_UNITS.append(PEN_CALORIE)
POUND_FOOT_PER_SECOND = UnitDescriptor(
    'pound foot per second', 'N10', """lb·(ft/s)"""
)
ALL_UNITS.append(POUND_FOOT_PER_SECOND)
POUND_INCH_PER_SECOND = UnitDescriptor(
    'pound inch per second', 'N11', """lb·(in/s)"""
)
ALL_UNITS.append(POUND_INCH_PER_SECOND)
PFERDESTAERKE = UnitDescriptor('Pferdestaerke', 'N12', """PS""")
ALL_UNITS.append(PFERDESTAERKE)
CENTIMETRE_OF_MERCURY_0_DEG_C = UnitDescriptor(
    'centimetre of mercury (0 ºC)', 'N13', """cmHg (0 ºC)"""
)
ALL_UNITS.append(CENTIMETRE_OF_MERCURY_0_DEG_C)
CENTIMETRE_OF_WATER_4_DEG_C = UnitDescriptor(
    'centimetre of water (4 ºC)', 'N14', """cmH₂O (4 °C)"""
)
ALL_UNITS.append(CENTIMETRE_OF_WATER_4_DEG_C)
FOOT_OF_WATER_39_2_DEG_F = UnitDescriptor(
    'foot of water (39.2 ºF)', 'N15', """ftH₂O (39,2 ºF)"""
)
ALL_UNITS.append(FOOT_OF_WATER_39_2_DEG_F)
INCH_OF_MERCURY_32_DEG_F = UnitDescriptor(
    'inch of mercury (32 ºF)', 'N16', """inHG (32 ºF)"""
)
ALL_UNITS.append(INCH_OF_MERCURY_32_DEG_F)
INCH_OF_MERCURY_60_DEG_F = UnitDescriptor(
    'inch of mercury (60 ºF)', 'N17', """inHg (60 ºF)"""
)
ALL_UNITS.append(INCH_OF_MERCURY_60_DEG_F)
INCH_OF_WATER_39_2_DEG_F = UnitDescriptor(
    'inch of water (39.2 ºF)', 'N18', """inH₂O (39,2 ºF)"""
)
ALL_UNITS.append(INCH_OF_WATER_39_2_DEG_F)
INCH_OF_WATER_60_DEG_F = UnitDescriptor(
    'inch of water (60 ºF)', 'N19', """inH₂O (60 ºF)"""
)
...
POUNDAL_PER_SQUARE_FOOT = UnitDescriptor(
    'poundal per square foot', 'N21', """pdl/ft²"""
)
ALL_UNITS.append(POUNDAL_PER_SQUARE_FOOT)
OUNCE_AVOIRDUPOIS_PER_SQUARE_INCH = UnitDescriptor(
    'ounce (avoirdupois) per square inch', 'N22', """oz/in²"""
)
ALL_UNITS.append(OUNCE_AVOIRDUPOIS_PER_SQUARE_INCH)
CONVENTIONAL_METRE_OF_WATER = UnitDescriptor(
    'conventional metre of water', 'N23', """mH₂O"""
)
ALL_UNITS.append(CONVENTIONAL_METRE_OF_WATER)
GRAM_PER_SQUARE_MILLIMETRE = UnitDescriptor(
    'gram per square millimetre', 'N24', """g/mm²"""
)
ALL_UNITS.append(GRAM_PER_SQUARE_MILLIMETRE)
POUND_PER_SQUARE_YARD = UnitDescriptor(
    'pound per square yard', 'N25', """lb/yd²"""
)
ALL_UNITS.append(POUND_PER_SQUARE_YARD)
POUNDAL_PER_SQUARE_INCH = UnitDescriptor(
    'poundal per square inch', 'N26', """pdl/in²"""
)
ALL_UNITS.append(POUNDAL_PER_SQUARE_INCH)
FOOT_TO_THE_FOURTH_POWER = UnitDescriptor(
    'foot to the fourth power', 'N27', """ft⁴"""
)
ALL_UNITS.append(FOOT_TO_THE_FOURTH_POWER)
CUBIC_DECIMETRE_PER_KILOGRAM = UnitDescriptor(
    'cubic decimetre per kilogram', 'N28', """dm³/kg"""
)
ALL_UNITS.append(CUBIC_DECIMETRE_PER_KILOGRAM)
CUBIC_FOOT_PER_POUND = UnitDescriptor(
    'cubic foot per pound', 'N29', """ft³/lb"""
)
ALL_UNITS.append(CUBIC_FOOT_PER_POUND)
PRINT_POINT = UnitDescriptor('print point', 'N3', """""")
ALL_UNITS.append(PRINT_POINT)
CUBIC_INCH_PER_POUND = UnitDescriptor(
    'cubic inch per pound', 'N30', """in³/lb"""
)
...
POUND_FORCE_PER_YARD = UnitDescriptor(
    'pound-force per yard', 'N33', """lbf/yd"""
)
ALL_UNITS.append(POUND_FORCE_PER_YARD)
POUNDAL_SECOND_PER_SQUARE_FOOT = UnitDescriptor(
    'poundal second per square foot', 'N34', """(pdl/ft²)·s"""
)
...
NEWTON_SECOND_PER_SQUARE_METRE = UnitDescriptor(
    'newton second per square metre', 'N36', """(N/m²)·s"""
)
ALL_UNITS.append(NEWTON_SECOND_PER_SQUARE_METRE)
KILOGRAM_PER_METRE_SECOND = UnitDescriptor(
    'kilogram per metre second', 'N37', """kg/(m·s)"""
)
ALL_UNITS.append(KILOGRAM_PER_METRE_SECOND)
KILOGRAM_PER_METRE_MINUTE = UnitDescriptor(
    'kilogram per metre minute', 'N38', """kg/(m·min)"""
)
ALL_UNITS.append(KILOGRAM_PER_METRE_MINUTE)
KILOGRAM_PER_METRE_DAY = UnitDescriptor(
    'kilogram per metre day', 'N39', """kg/(m·d)"""
)
ALL_UNITS.append(KILOGRAM_PER_METRE_DAY)
KILOGRAM_PER_METRE_HOUR = UnitDescriptor(
    'kilogram per metre hour', 'N40', """kg/(m·h)"""
)
ALL_UNITS.append(KILOGRAM_PER_METRE_HOUR)
GRAM_PER_CENTIMETRE_SECOND = UnitDescriptor(
    'gram per centimetre second', 'N41', """g/(cm·s)"""
)
ALL_UNITS.append(GRAM_PER_CENTIMETRE_SECOND)
POUNDAL_SECOND_PER_SQUARE_INCH = UnitDescriptor(
    'poundal second per square inch', 'N42', """(pdl/in²)·s"""
)
ALL_UNITS.append(POUNDAL_SECOND_PER_SQUARE_INCH)
POUND_PER_FOOT_MINUTE = UnitDescriptor(
    'pound per foot minute', 'N43', """lb/(ft·min)"""
)
ALL_UNITS.append(POUND_PER_FOOT_MINUTE)
POUND_PER_FOOT_DAY = UnitDescriptor(
    'pound per foot day', 'N44', """lb/(ft·d)"""
)
ALL_UNITS.append(POUND_PER_FOOT_DAY)
CUBIC_METRE_PER_SECOND_PASCAL = UnitDescriptor(
    'cubic metre per second pascal', 'N45', """(m³/s)/Pa"""
)
...
WATT_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'watt per square centimetre', 'N48', """W/cm²"""
)
ALL_UNITS.append(WATT_PER_SQUARE_CENTIMETRE)
WATT_PER_SQUARE_INCH = UnitDescriptor(
    'watt per square inch', 'N49', """W/in²"""
)
ALL_UNITS.append(WATT_PER_SQUARE_INCH)
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_SQUARE_FOOT_HOUR = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_SQUARE_FOOT_HOUR = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_SQUARE_FOOT_MINUTE = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_SQUARE_FOOT_SECOND = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_CUBIC_FOOT = UnitDescriptor(
    'British thermal unit (thermochemical) per cubic foot',
    'N59',
    """Btuth/ft³""",
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_CUBIC_FOOT)
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_DEGREE_FAHRENHEIT = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_DEGREE_RANKINE = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_DEGREE_RANKINE = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_POUND_DEGREE_RANKINE = UnitDescriptor(
...
KILOCALORIE_INTERNATIONAL_TABLE_PER_GRAM_KELVIN = UnitDescriptor(
    'kilocalorie (international table) per gram kelvin',
    'N65',
    """(kcalIT/K)/g""",
)
ALL_UNITS.append(KILOCALORIE_INTERNATIONAL_TABLE_PER_GRAM_KELVIN)
BRITISH_THERMAL_UNIT_39_DEG_F = UnitDescriptor(
    'British thermal unit (39 ºF)', 'N66', """Btu (39 ºF) """
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_39_DEG_F)
BRITISH_THERMAL_UNIT_59_DEG_F = UnitDescriptor(
    'British thermal unit (59 ºF)', 'N67', """Btu (59 ºF)"""
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_59_DEG_F)
BRITISH_THERMAL_UNIT_60_DEG_F = UnitDescriptor(
    'British thermal unit (60 ºF)', 'N68', """Btu (60 ºF) """
)
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_POUND = UnitDescriptor(
    'British thermal unit (thermochemical) per pound', 'N73', """Btuth/lb"""
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_POUND)
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_HOUR_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
        'British thermal unit (international table) per hour square foot degree'
        ' Fahrenheit'
    ),
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_HOUR_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_SECOND_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
        'British thermal unit (international table) per second square foot'
        ' degree Fahrenheit'
    ),
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_SECOND_SQUARE_FOOT_DEGREE_FAHRENHEIT = UnitDescriptor(
    (
...
KILOWATT_PER_SQUARE_METRE_KELVIN = UnitDescriptor(
    'kilowatt per square metre kelvin', 'N78', """kW/(m²·K)"""
)
...
WATT_PER_METRE_DEGREE_CELSIUS = UnitDescriptor(
    'watt per metre degree Celsius', 'N80', """W/(m·°C)"""
)
ALL_UNITS.append(WATT_PER_METRE_DEGREE_CELSIUS)
KILOWATT_PER_METRE_KELVIN = UnitDescriptor(
    'kilowatt per metre kelvin', 'N81', """kW/(m·K)"""
)
ALL_UNITS.append(KILOWATT_PER_METRE_KELVIN)
KILOWATT_PER_METRE_DEGREE_CELSIUS = UnitDescriptor(
    'kilowatt per metre degree Celsius', 'N82', """kW/(m·°C)"""
)
ALL_UNITS.append(KILOWATT_PER_METRE_DEGREE_CELSIUS)
METRE_PER_DEGREE_CELCIUS_METRE = UnitDescriptor(
    'metre per degree Celcius metre', 'N83', """m/(°C·m)"""
)
...
DEGREE_FAHRENHEIT_HOUR_PER_BRITISH_THERMAL_UNIT_THERMOCHEMICAL = UnitDescriptor(
...
DEGREE_FAHRENHEIT_HOUR_SQUARE_FOOT_PER_BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_INCH = UnitDescriptor(
    (
        'degree Fahrenheit hour square foot per British thermal unit'
...
MILLIGRAM_PER_KILOGRAM = UnitDescriptor(
    'milligram per kilogram', 'NA', """mg/kg"""
)
...
NUMBER_OF_INTERNATIONAL_UNITS = UnitDescriptor(
...
POUND_PER_AIR_DRY_METRIC_TON = UnitDescriptor(
...
OZONE_DEPLETION_EQUIVALENT = UnitDescriptor(
...
OUNCE_PER_SQUARE_YARD = UnitDescriptor(
    'ounce per square yard', 'ON', """oz/yd²"""
)
...
OSCILLATIONS_PER_MINUTE = UnitDescriptor(
    'oscillations per minute', 'OPM', """o/min"""
)
...
KILOJOULE_PER_MINUTE = UnitDescriptor(
    'kilojoule per minute', 'P19', """kJ/min"""
)
...
OHM_CIRCULAR_MIL_PER_FOOT = UnitDescriptor(
    'ohm circular-mil per foot', 'P23', """Ω·cmil/ft """
)
ALL_UNITS.append(OHM_CIRCULAR_MIL_PER_FOOT)
KILOHENRY = UnitDescriptor('kilohenry', 'P24', """kH""")
ALL_UNITS.append(KILOHENRY)
LUMEN_PER_SQUARE_FOOT = UnitDescriptor(
    'lumen per square foot', 'P25', """lm/ft²"""
)
...
CANDELA_PER_SQUARE_INCH = UnitDescriptor(
    'candela per square inch', 'P28', """cd/in²"""
)
...
CANDELA_PER_SQUARE_FOOT = UnitDescriptor(
    'candela per square foot', 'P32', """cd/ft²"""
)
...
BRITISH_THERMAL_UNIT_INTERNATIONAL_TABLE_PER_SQUARE_FOOT = UnitDescriptor(
...
BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_SQUARE_FOOT = UnitDescriptor(
    'British thermal unit (thermochemical) per square foot',
    'P38',
    """Btuth/ft²""",
)
ALL_UNITS.append(BRITISH_THERMAL_UNIT_THERMOCHEMICAL_PER_SQUARE_FOOT)
CALORIE_THERMOCHEMICAL_PER_SQUARE_CENTIMETRE = UnitDescriptor(
    'calorie (thermochemical) per square centimetre', 'P39', """calth/cm²"""
)
...
PASCAL_SQUARED_SECOND = UnitDescriptor(
    'pascal squared second', 'P42', """Pa²·s"""
)
...
POUND_MOLE_PER_SECOND = UnitDescriptor(
    'pound mole per second', 'P45', """lbmol/s"""
)
ALL_UNITS.append(POUND_MOLE_PER_SECOND)
POUND_MOLE_PER_MINUTE = UnitDescriptor(
    'pound mole per minute', 'P46', """lbmol/h"""
)
ALL_UNITS.append(POUND_MOLE_PER_MINUTE)
KILOMOLE_PER_KILOGRAM = UnitDescriptor(
    'kilomole per kilogram', 'P47', """kmol/kg"""
)
ALL_UNITS.append(KILOMOLE_PER_KILOGRAM)
POUND_MOLE_PER_POUND = UnitDescriptor(
    'pound mole per pound', 'P48', """lbmol/lb"""
)
ALL_UNITS.append(POUND_MOLE_PER_POUND)
NEWTON_SQUARE_METRE_PER_AMPERE = UnitDescriptor(
    'newton square metre per ampere', 'P49', """N·m²/A"""
)
...
MOL_PER_KILOGRAM_PASCAL = UnitDescriptor(
    'mol per kilogram pascal', 'P51', """(mol/kg)/Pa"""
)
ALL_UNITS.append(MOL_PER_KILOGRAM_PASCAL)
MOL_PER_CUBIC_METRE_PASCAL = UnitDescriptor(
    'mol per cubic metre pascal', 'P52', """(mol/m³)/Pa"""
)
ALL_UNITS.append(MOL_PER_CUBIC_METRE_PASCAL)
UNIT_POLE = UnitDescriptor('unit pole', 'P53', """unit pole """)
ALL_UNITS.append(UNIT_POLE)
MILLIGRAY_PER_SECOND = UnitDescriptor(
    'milligray per second', 'P54', """mGy/s"""
)
ALL_UNITS.append(MILLIGRAY_PER_SECOND)
MICROGRAY_PER_SECOND = UnitDescriptor(
    'microgray per second', 'P55', """µGy/s"""
)
...
MILLIGRAY_PER_MINUTE = UnitDescriptor(
    'milligray per minute', 'P58', """mGy/min"""
)
ALL_UNITS.append(MILLIGRAY_PER_MINUTE)
MICROGRAY_PER_MINUTE = UnitDescriptor(
    'microgray per minute', 'P59', """µGy/min"""
)
ALL_UNITS.append(MICROGRAY_PER_MINUTE)
SIX_PACK = UnitDescriptor('six pack', 'P6', """""")
ALL_UNITS.append(SIX_PACK)
NANOGRAY_PER_MINUTE = UnitDescriptor(
    'nanogray per minute', 'P60', """nGy/min"""
)
...
MILLISIEVERT_PER_SECOND = UnitDescriptor(
    'millisievert per second', 'P66', """mSv/s"""
)
ALL_UNITS.append(MILLISIEVERT_PER_SECOND)
MICROSIEVERT_PER_SECOND = UnitDescriptor(
    'microsievert per second', 'P67', """µSv/s"""
)
ALL_UNITS.append(MICROSIEVERT_PER_SECOND)
NANOSIEVERT_PER_SECOND = UnitDescriptor(
    'nanosievert per second', 'P68', """nSv/s"""
)
...
MILLISIEVERT_PER_HOUR = UnitDescriptor(
    'millisievert per hour', 'P71', """mSv/h"""
)
ALL_UNITS.append(MILLISIEVERT_PER_HOUR)
MICROSIEVERT_PER_HOUR = UnitDescriptor(
    'microsievert per hour', 'P72', """µSv/h"""
)
ALL_UNITS.append(MICROSIEVERT_PER_HOUR)
NANOSIEVERT_PER_HOUR = UnitDescriptor(
    'nanosievert per hour', 'P73', """nSv/h"""
)
...
MILLISIEVERT_PER_MINUTE = UnitDescriptor(
    'millisievert per minute', 'P75', """mSv/min"""
)
ALL_UNITS.append(MILLISIEVERT_PER_MINUTE)
MICROSIEVERT_PER_MINUTE = UnitDescriptor(
    'microsievert per minute', 'P76', """µSv/min"""
)
ALL_UNITS.append(MICROSIEVERT_PER_MINUTE)
NANOSIEVERT_PER_MINUTE = UnitDescriptor(
    'nanosievert per minute', 'P77', """nSv/min"""
)
ALL_UNITS.append(NANOSIEVERT_PER_MINUTE)
RECIPROCAL_SQUARE_INCH = UnitDescriptor(
    'reciprocal square inch', 'P78', """1/in²"""
)
ALL_UNITS.append(RECIPROCAL_SQUARE_INCH)
PASCAL_SQUARE_METRE_PER_KILOGRAM = UnitDescriptor(
    'pascal square metre per kilogram', 'P79', """Pa/(kg/m²)"""
)
ALL_UNITS.append(PASCAL_SQUARE_METRE_PER_KILOGRAM)
EIGHT_PACK = UnitDescriptor('eight pack', 'P8', """""")
ALL_UNITS.append(EIGHT_PACK)
MILLIPASCAL_PER_METRE = UnitDescriptor(
    'millipascal per metre', 'P80', """mPa/m"""
)
ALL_UNITS.append(MILLIPASCAL_PER_METRE)
KILOPASCAL_PER_METRE = UnitDescriptor(
    'kilopascal per metre', 'P81', """kPa/m"""
)
ALL_UNITS.append(KILOPASCAL_PER_METRE)
HECTOPASCAL_PER_METRE = UnitDescriptor(
    'hectopascal per metre', 'P82', """hPa/m"""
)
ALL_UNITS.append(HECTOPASCAL_PER_METRE)
STANDARD_ATMOSPHERE_PER_METRE = UnitDescriptor(
    'standard atmosphere per metre', 'P83', """Atm/m"""
)
ALL_UNITS.append(STANDARD_ATMOSPHERE_PER_METRE)
TECHNICAL_ATMOSPHERE_PER_METRE = UnitDescriptor(
    'technical atmosphere per metre', 'P84', """at/m"""
)
...
CUBIC_METRE_PER_SECOND_SQUARE_METRE = UnitDescriptor(
    'cubic metre per second square metre', 'P87', """(m³/s)/m²"""
)
ALL_UNITS.append(CUBIC_METRE_PER_SECOND_SQUARE_METRE)
RHE = UnitDescriptor('rhe', 'P88', """rhe""")
ALL_UNITS.append(RHE)
POUND_FORCE_FOOT_PER_INCH = UnitDescriptor(
    'pound-force foot per inch', 'P89', """lbf·ft/in"""
)
ALL_UNITS.append(POUND_FORCE_FOOT_PER_INCH)
NINE_PACK = UnitDescriptor('nine pack', 'P9', """""")
ALL_UNITS.append(NINE_PACK)
POUND_FORCE_INCH_PER_INCH = UnitDescriptor(
    'pound-force inch per inch', 'P90', """lbf·in/in"""
)
...
KILOBYTE_PER_SECOND = UnitDescriptor(
    'kilobyte per second', 'P94', """kbyte/s"""
)
ALL_UNITS.append(KILOBYTE_PER_SECOND)
MEGABYTE_PER_SECOND = UnitDescriptor(
    'megabyte per second', 'P95', """Mbyte/s"""
)
...
PASCAL_TO_THE_POWER_SUM_OF_STOICHIOMETRIC_NUMBERS = UnitDescriptor(
    'pascal to the power sum of stoichiometric numbers', 'P98', """PaΣνB"""
)
...
POUND_PER_INCH_OF_LENGTH = UnitDescriptor(
    'pound per inch of length', 'PO', """lb/in"""
)
...
POUND_FORCE_PER_SQUARE_INCH = UnitDescriptor(
    'pound-force per square inch', 'PS', """lbf/in²"""
)
...
POUND_PER_INCH_OF_WIDTH = UnitDescriptor(
...
NATURAL_UNIT_OF_INFORMATION = UnitDescriptor(
    'natural unit of information', 'Q16', """nat"""
)
...
NATURAL_UNIT_OF_INFORMATION_PER_SECOND = UnitDescriptor(
    'natural unit of information per second', 'Q19', """nat/s"""
)
...
SECOND_PER_RADIAN_CUBIC_METRE = UnitDescriptor(
    'second per radian cubic metre', 'Q22', """1/(Hz·rad·m³)"""
)
ALL_UNITS.append(SECOND_PER_RADIAN_CUBIC_METRE)
WEBER_TO_THE_POWER_MINUS_ONE = UnitDescriptor(
    'weber to the power minus one', 'Q23', """1/Wb"""
)
...
NEWTON_METRE_PER_METRE = UnitDescriptor(
    'newton metre per metre', 'Q27', """N·m/m²"""
)
ALL_UNITS.append(NEWTON_METRE_PER_METRE)
KILOGRAM_PER_SQUARE_METRE_PASCAL_SECOND = UnitDescriptor(
    'kilogram per square metre pascal second', 'Q28', """kg/(m²·Pa·s)"""
)
ALL_UNITS.append(KILOGRAM_PER_SQUARE_METRE_PASCAL_SECOND)
MICROGRAM_PER_HECTOGRAM = UnitDescriptor(
    'microgram per hectogram', 'Q29', """µg/hg"""
)
ALL_UNITS.append(MICROGRAM_PER_HECTOGRAM)
PH_POTENTIAL_OF_HYDROGEN = UnitDescriptor(
    'pH (potential of Hydrogen)', 'Q30', """pH"""
)
...
MEGAWATTS_PER_MINUTE = UnitDescriptor(
    'megawatts per minute', 'Q35', """MW/min"""
)
ALL_UNITS.append(MEGAWATTS_PER_MINUTE)
SQUARE_METRE_PER_CUBIC_METRE = UnitDescriptor(
    'square metre per cubic metre', 'Q36', """m2/m3"""
)
ALL_UNITS.append(SQUARE_METRE_PER_CUBIC_METRE)
STANDARD_CUBIC_METRE_PER_DAY = UnitDescriptor(
    'Standard cubic metre per day', 'Q37', """"""
)
ALL_UNITS.append(STANDARD_CUBIC_METRE_PER_DAY)
STANDARD_CUBIC_METRE_PER_HOUR = UnitDescriptor(
    'Standard cubic metre per hour', 'Q38', """"""
)
ALL_UNITS.append(STANDARD_CUBIC_METRE_PER_HOUR)
NORMALIZED_CUBIC_METRE_PER_DAY = UnitDescriptor(
...
JOULE_PER_NORMALISED_CUBIC_METRE = UnitDescriptor(
    'Joule per normalised cubic metre', 'Q41', """"""
)
ALL_UNITS.append(JOULE_PER_NORMALISED_CUBIC_METRE)
JOULE_PER_STANDARD_CUBIC_METRE = UnitDescriptor(
...
RUNNING_OR_OPERATING_HOUR = UnitDescriptor(
...
REVOLUTIONS_PER_MINUTE = UnitDescriptor(
    'revolutions per minute', 'RPM', """r/min"""
)
ALL_UNITS.append(REVOLUTIONS_PER_MINUTE)
REVOLUTIONS_PER_SECOND = UnitDescriptor(
    'revolutions per second', 'RPS', """r/s"""
)
...
SQUARE_FOOT_PER_SECOND = UnitDescriptor(
    'square foot per second', 'S3', """ft²/s"""
)
ALL_UNITS.append(SQUARE_FOOT_PER_SECOND)
SQUARE_METRE_PER_SECOND = UnitDescriptor(
    'square metre per second', 'S4', """m²/s"""
)
ALL_UNITS.append(SQUARE_METRE_PER_SECOND)
SIXTY_FOURTHS_OF_AN_INCH = UnitDescriptor(
...
STANDARD_ADVERTISING_UNIT = UnitDescriptor(
...
SHORT_STANDARD_7200_MATCHES = UnitDescriptor(
...
TON_US_OR_SHORT_TON_UK_PER_US = UnitDescriptor(
    'ton (US) or short ton (UK/US)', 'STN', """ton (US)"""
)
...
TELECOMMUNICATION_LINE_IN_SERVICE = UnitDescriptor(
...
KILOAMPERE_HOUR_THOUSAND_AMPERE_HOUR = UnitDescriptor(
    'kiloampere hour (thousand ampere hour)', 'TAH', """kA·h"""
)
...
KILOGRAM_OF_IMPORTED_MEAT_LESS_OFFAL = UnitDescriptor(
...
THOUSAND_CUBIC_METRE_PER_DAY = UnitDescriptor(
    'thousand cubic metre per day', 'TQD', """km³/d"""
)
...
TONNE_OF_SUBSTANCE_90_PERCENT_DRY = UnitDescriptor(
...
TELECOMMUNICATION_LINE_IN_SERVICE_AVERAGE = UnitDescriptor(
...
USAGE_PER_TELECOMMUNICATION_LINE_AVERAGE = UnitDescriptor(
...
VOLT_AMPERE_PER_KILOGRAM = UnitDescriptor(
    'volt - ampere per kilogram', 'VA', """V·A / kg"""
)
...
FORMAZIN_NEPHELOMETRIC_UNIT = UnitDescriptor(
    'Formazin nephelometric unit', 'FNU', """FNU"""
)
ALL_UNITS.append(FORMAZIN_NEPHELOMETRIC_UNIT)
NEPHELOMETRIC_TURBIDITY_UNIT = UnitDescriptor(
